    ...
    [60802], {
      ...
      29075: (e, t, n) => {
        ...
        D.before((function(e, t) {
          ...
          (0, a.J7)(n.renderer) ? ((0, a.Pg)(n.renderer, n, r), O({
            doc: r,
            bid: n,
            id: n.adId
          }), e.bail()) : e(t)
        ...
        function P(e, t, n) {
          ...
          function a(t, n) {
            ...
            r && (t && (r.width = t, r.style.width && (r.style.width = `${t}px`)), n && (r.height = n, r.style.height && (r.style.height = `${n}px`)))
          }
          const d = (c = {
            resizeFn: a
          }, function(e, t, n) {
      ...
      11445: (e, t, n) => {
        ...
        const P = (0, d.A_)("sync", (function(e) {
          let {
            bidderCode: t,
            auctionId: n,
            bidderRequestId: i,
        ...
        const M = (0, d.A_)("sync", (function(e, t) {
          let {
            getS2SBidders: n = L
        ...
        const G = (0, d.A_)("sync", ((e, t) => e), "setupAdUnitMediaTypes");
        ...
        D.makeBidRequests = (0, d.A_)("sync", (function(e, t, n, o, s) {
          ...
          l = (0, A.BO)(l), v.emit(E.qY.BEFORE_REQUEST_BIDS, e), (0, i.nk)(e), e.map((e => e.code)).filter(r.uniques).forEach(g), e.forEach((e => {
            (0, r.isPlainObject)(e.mediaTypes) || (e.mediaTypes = {}), e.bids = e.bids.filter((e => !e.bidder || U.isAllowed(C.uc, N(w.tW, e.bidder)))), u(e.code, "requestsCounter")
          })), e = G(e, s);
          let {
            [k.CLIENT]: f, [k.SERVER]: p
          } = F(e, $);
            ...
            if (i && i.enabled && U.isAllowed(C.uc, o)) {
              let {
                ...
                return n.forEach((e => {
                  ...
                  1 === n.length ? (e.s2sBid = n[0], i = !0, e.ortb2Imp = (0, r.mergeDeep)({}, e.s2sBid.ortb2Imp, e.ortb2Imp)) : n.length > 1 && (0, r.logWarn)('Multiple "module" bids for the same s2s configuration; all will be ignored', n), e.bids = M(e.bids, t).map((e => (e.bid_id = (0, r.getUniqueIdentifierStr)(), e)))
          ...
          e && t ? "function" == typeof e.callBids ? (_[t] = e, y.o2.register(w.tW, t, e.getSpec?.().gvlid), (0, c.mK)(n, "video") && D.videoAdapters.push(t), (0, c.mK)(n, "native") && i.mT.push(t)) : (0, r.logError)("Bidder adaptor error for bidder code: " + t + "bidder must implement a callBids() function") : (0, r.logError)("bidAdapter or bidderCode not specified")
          ...
          var i, o;
          t.params = (0, r.getUserConfiguredParams)(n, t.adUnitCode, t.bidder), i = t.adUnitCode, o = t.bidder, u(i, "winsCounter", o), V(e, "onBidWon", t)
        }, D.triggerBilling = (() => {
          const e = new WeakSet;
          return t => {
            e.has(t) || (e.add(t), ((0, B.$T)(t.eventtrackers)[B.OA]?.[B.Ni] || []).forEach((e => r.internal.triggerPixel(e))), V(t.bidder, "onBidBillable", t))
          }
      ...
      57377: (e, t, n) => {
              ...
              E.forEach((e => {
                ...
                onBid: t => {
                  ...
                  if (n) {
                    ...
                    const i = Object.assign((0, s.O)(l.XQ.GOOD, n), t, (0, f.pick)(n, w));
                    ! function(e, t) {
        ...
        const O = ["bids", "paapi"],
          B = (0, p.A_)("async", (function(e, t, n, r, i, o) {
            let {
              onRequest: s,
              onResponse: a,
              onPaapi: d,
            ...
            if (!b || 0 === b.length) return void g();
            Array.isArray(b) || (b = [b]);
            const I = (0, f.delayExecution)(g, b.length);
            b.forEach((t => {
              const n = p.fork();
              ...
              const g = i((function(r, i) {
                  ...
                  try {
                    ...
                    return (0, f.logError)(`Bidder ${e.code} failed to interpret the server's response. Continuing without bids`, null, t), void I()
                  }
                  let s, c;
                  r && !Object.keys(r).some((e => !O.includes(e))) ? (s = r.bids, c = r.paapi) : s = r, (0, f.isArray)(c) && c.forEach(d), s && ((0, f.isArray)(s) ? s.forEach(o) : o(s)), I()
                })),
                m = i((function(e, t) {
                  b(), c(e, t), I()
                }));
              ...
              switch (t.method) {
                ...
                case "POST":
                  const n = t.options?.endpointCompression,
                    i = "TRUE" === (0, f.getParameterByName)(l.M).toUpperCase() || (0, f.debugTurnedOn)(),
                    o = e => {
                      let {
                        url: t,
                        payload: n
                  ...
                  n && i && (0, f.logWarn)(`Skipping GZIP compression for ${e.code} as debug mode is enabled`), n && !i && (0, f.isGzipCompressionSupported)() ? (0, f.compressDataWithGZip)(t.data).then((e => {
                    const n = new URL(t.url, window.location.origin);
                    n.searchParams.has("gzip") || n.searchParams.set("gzip", "1"), o({
                      url: n.href,
                      payload: e
                    })
                  })) : o({
                  ...
                  break;
                default:
                  (0, f.logWarn)(`Skipping invalid request from ${e.code}. Request type ${t.type} must be GET or POST`), I()
              }
            }))
      ...
      81657: (e, t, n) => {
        ...
        function j(e) {
          ...
          function ce(e) {
            if (e ? h.emit(y.qY.AUCTION_TIMEOUT, de()) : clearTimeout(Z), void 0 === Q) {
              let n = [];
              e && ((0, r.logMessage)(`Auction ${z} timedOut`), n = re.filter((e => !V.has(e.bidderRequestId))).flatMap((e => e.bids)), n.length && h.emit(y.qY.BID_TIMEOUT, n)), ee = B, Q = Date.now(), j.checkpoint("auctionEnd"), j.timeBetween("requestBids", "auctionEnd", "requestBids.total"), j.timeBetween("callBids", "auctionEnd", "requestBids.callBids"), K.resolve(), h.emit(y.qY.AUCTION_END, de()), q(G, (function() {
                try {
                  if (null != ne) {
                    const t = ie.toArray().filter((e => F.includes(e.adUnitCode))).reduce(X, {});
                    ne.apply(_, [t, e, z]), ne = null
                  }
                } catch (e) {
          ...
          function le() {
            d.$W.resetBidder(), (0, r.logInfo)(`Bids Received for Auction with id: ${z}`, ie.toArray()), ee = B, ce(!1)
          }
          ...
          function ge(e) {
            ...
            let t = {},
              n = {
                bidRequests: e,
                run: () => {
                  Z = setTimeout((() => ce(!0)), H), ee = O, h.emit(y.qY.AUCTION_INIT, de());
                  let n = function(e, t) {
                    let {
                      index: n = p.n.index
                    } = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, c = 0, l = !1, m = new Set, b = {};
                      ...
                      A(e, c, (e => {
                        let l = function(e) {
                          ...
                          const g = M(e.mediaType, s, d.$W.getConfig("mediaTypePriceGranularity")),
                            f = (0, i.j)(e.cpm, "object" == typeof g ? g : d.$W.getConfig("customPriceBucket"), d.$W.getConfig("currency.granularityMultiplier"));
                          return e.pbLg = f.low, e.pbMg = f.med, e.pbHg = f.high, e.pbAg = f.auto, e.pbDg = f.dense, e.pbCg = f.custom, e
                        }(c);
                        h.emit(y.qY.BID_ACCEPTED, l), l.mediaType === f.G_ ? function(e, t, n) {
                          let {
                            index: i = p.n.index
                          ...
                          u ? (0, s.Sb)(t) : f && (l || c !== g.H6) && (!t.videoCacheKey || m ? (o = !1, P(e, t, n, a)) : t.vastUrl || ((0, r.logError)("videoCacheKey specified but not required vastUrl for video bid"), o = !1));
                          o && (W(e, t), n())
                        }(t, l, e) : ((0, o.l6)(l) && (0, o.gs)(l, n.getAdUnit(l)), W(t, l), e())
                      }))
                    }
                    ...
                    function T() {
                      ...
                      if (m.add(n), o && !(0, r.isEmpty)(o)) {
                        const e = o.secondaryBidders;
                        e && !i.every((t => (0, u.mK)(e, t.bidderCode))) && (i = i.filter((t => !(0, u.mK)(e, t.bidderCode))))
                      }
                      l = i.every((e => m.has(e))), n.bids.forEach((e => {
                        b[e.bidId] || (t.addNoBid(e), h.emit(y.qY.NO_BID, e))
                      })), l && 0 === c && e()
                    }
                    return {
            ...
            c(n) || ((0, r.logWarn)("queueing auction due to limited endpoint capacity"), D.push(n))
          }
          return (0, T.lc)((() => ie.refresh())), h.on(y.qY.SEAT_NON_BID, (e => {
            var t;
            ...
            callBids: function() {
              ...
              (0, r.logInfo)(`Bids Requested for Auction with id: ${z}`, e), j.checkpoint("callBids"), e.length < 1 ? ((0, r.logWarn)("No valid bid requests returned for auction"), le()) : N.call({
                dispatch: ge,
                context: this
              }, e)
            },
            addWinningBid: function(e) {
              se = se.concat(e), b.Ay.callBidWonBidder(e.adapterCode || e.bidder, e, t), e.deferBilling || b.Ay.triggerBilling(e)
            },
        ...
        function J(e, t) {
          ...
          if (n[y.iD.ADSERVER_TARGETING] || (n[y.iD.ADSERVER_TARGETING] = [K(y.xS.BIDDER, "bidderCode"), K(y.xS.AD_ID, "adId"), K(y.xS.PRICE_BUCKET, L()), K(y.xS.SIZE, "size"), K(y.xS.DEAL, "dealId"), K(y.xS.SOURCE, "source"), K(y.xS.FORMAT, "mediaType"), K(y.xS.ADOMAIN, z()), K(y.xS.ACAT, V()), K(y.xS.DSP, H()), K(y.xS.CRID, F())]), "video" === e) {
          ...
          function u() {
            if (a && n && (0, o.isPlainObject)(n[a])) {
              ...
              for (const n of r) {
                const r = t[n],
                  s = e[n];
                i[n] = void 0 === s ? r : void 0 === r ? s : (0, o.isPlainObject)(s) ? (0, o.mergeDeep)({}, r, s) : s
              }
              return i
            }
            return {
      ...
      70068: (e, t, n) => {
        ...
        const b = {
          ...
          y = (0, u.i8)("FPD"),
          v = (0, r.A_)("sync", (e => {
            const t = [e, A().catch((() => null)), l.U9.resolve("cookieDeprecationLabel" in navigator && (0, g.io)(p.Ue, (0, f.s)(m.tp, "cdep")) && navigator.cookieDeprecationLabel.getValue()).catch((() => null))];
            return l.U9.all(t).then((e => {
              ...
              o && (0, a.J)(t, "site.ext.data.documentLang", o), t = y(t);
              for (let e of u.Dy)
                if ((0, u.O$)(t, e)) {
        ...
        const w = {
          site(e, t) {
            if (!u.Dy.filter((e => "site" !== e)).some(u.O$.bind(null, e))) return I({
              page: t.page,
              ref: t.ref
            })
          },
          ...
          regs() {
            const e = {};
            E((e => e.navigator.globalPrivacyControl)) && (0, a.J)(e, "ext.gpc", "1");
      ...
      77332: (e, t, n) => {
        ...
        function y(e, t) {
          return function(n, r) {
            ! function(e) {
              ...
              function l(e, t) {
                return (0, i.isGptPubadsDefined)() ? u(e) : (0, i.isApnGetTagDefined)() ? g(t) : t
              }
              ...
              function g(e) {
                ...
                } else(0, i.logError)(`Unable to locate matching page element for adUnitCode ${r}.  Can't resize it to ad's dimensions.  Please review setup.`)
              }))
            }({
              ...t,
              width: n,
        ...
        }(0, T.L6)(), W.bidderSettings = W.bidderSettings || {}, W.libLoaded = !0, W.version = "v9.44.1", (0, i.logInfo)("Prebid.js v9.44.1 loaded"), W.installedModules = W.installedModules || [], W.adUnits = W.adUnits || [], W.triggerUserSyncs = P;
        const Q = {
          validateAdUnit: X,
        ...
        const Z = (0, w.A_)("sync", (function(e) {
          const t = [];
          return e.forEach((e => {
        ...
        W.getAdserverTargetingForAdUnitCodeStr = function(e) {
          ...
          (0, i.logInfo)("Invoking pbjs.setTargetingForAn", arguments), I.iS.isApntagDefined() ? (I.iS.setTargetingForAst(e), B.emit(L, I.iS.getAllTargeting())) : (0, i.logError)("window.apntag is not defined on the page")
        }, W.renderAd = (0, w.A_)("async", (function(e, t, n) {
          ...
          return (0, w.Y6)(e, N((() => !E.$W.getConfig("allowPrerendering")), (function() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              n = t.adUnits || W.adUnits;
            return t.adUnits = (0, i.isArray)(n) ? n.slice() : [n], t.metrics = (0, R.K7)(), t.metrics.checkpoint("requestBids"), t.defer = (0, k.v6)({
              promiseFactory: e => new Promise(e)
            }), e.call(this, t), t.defer.promise
          })))
        }();
        const te = (0, w.A_)("async", (function() {
          let {
            bidsBackHandler: e,
            timeout: t,
            adUnits: n,
        ...
        W.requestBids.before((function(e, t) {
          ...
          (0, i.logInfo)("Invoking pbjs.onEvent", arguments), (0, i.isFn)(t) ? !n || F[e].call(null, n) ? B.on(e, t, n) : (0, i.logError)('The id provided is not valid for event "' + e + '" and no handler was set.'): (0, i.logError)('The event handler provided is not a function and was not set on event "' + e + '".')
        }, W.offEvent = function(e, t, n) {
          (0, i.logInfo)("Invoking pbjs.offEvent", arguments), n && !F[e].call(null, n) || B.off(e, t, n)
        ...
        W.enableAnalytics = function(e) {
        ...
        }, W.aliasRegistry = O.Ay.aliasRegistry, E.$W.getConfig("aliasRegistry", (e => {
          ...
          W.que.push = W.cmd.push = ie, (0, l.XO)(), w.A_.ready(), oe(W.que), oe(W.cmd)
        })), W.triggerBilling = e => {
          let {
            adId: t,
            adUnitCode: n
        ...
        const O = function(e) {
          ...
          function I() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : m.Bq,
              ...
              i = e.getBidsReceived().reduce(((e, t) => {
                ...
                return (r || o) && a && (0, p.A)(t, "video.context") !== l.LM && w(t) && (t.latestTargetedAuctionId = n[t.adUnitCode], e.push(t)), e
              }), []);
          ...
          return t.setLatestAuctionForAdUnit = function(e, t) {
                ...
                d = O(t, i).concat(function(e) {
                  ...
                  function r(e) {
                    ...
                    return Object.keys(t).map((function(e) {
                      return (0, f.isStr)(t[e]) && (t[e] = t[e].split(",").map((e => e.trim()))), (0, f.isArray)(t[e]) || (t[e] = [t[e]]), {
                        [e]: t[e]
                      }
                    }))
                  }
            ...
            Object.entries(S(Object.keys(i), r)).forEach((e => {
              let [t, n] = e;
              n.length > 1 && (0, f.logWarn)(`Multiple slots found matching: ${t}. Targeting will be set on all matching slots, which can lead to duplicate impressions if more than one are requested from GAM. To resolve this, ensure the arguments to setTargetingForGPTAsync resolve to a single slot by explicitly matching the desired slotElementID.`), n.forEach((e => {
      ...
      91069: (e, t, n) => {
        ...
        let b, y, v = Boolean(window.console),
          E = Boolean(v && window.console.log),
          A = Boolean(v && window.console.info),
          I = Boolean(v && window.console.warn),
          w = Boolean(v && window.console.error);
        const T = (0, d.m)();
        ...
        const O = function() {
          let e;
          return () => ((!y || !e || Date.now() - e > 20) && (R.resetWinDimensions(), e = Date.now()), y)
        }();
        ...
        function Y() {
          try {
            if (R.getWindowTop().location.href) return !0
          } catch (e) {
            return !1
          }
        }
        ...
        function Z() {
          ie() && I && console.warn.apply(console, ne(arguments, "WARNING:")), S(s.qY.AUCTION_DEBUG, {
            type: "WARNING",
            arguments
          })
        }
        ...
        function ee() {
          ie() && w && console.error.apply(console, ne(arguments, "ERROR:")), S(s.qY.AUCTION_DEBUG, {
            type: "ERROR",
            arguments
          })
        }
        ...
        function be(e, t) {
          if (ce(e?.forEach)) return e.forEach(t, this);
        ...
        function Ie(e, t, n) {
          const r = new Image;
          t && R.isFn(t) && Ae(r, n).then(t), r.src = e
        }
        ...
        function we(e) {
          ...
          const t = se();
          var n;
          R.insertElement(t, document, "body"), (n = t.contentWindow.document).open(), n.write(e), n.close()
        }
        ...
        function Te(e, t, n) {
          ...
          i.innerHTML = r;
          let o = i.firstChild;
          t && R.isFn(t) && Ae(o, n).then(t), R.insertElement(o, document, "html", !0)
        }
        ...
        function Oe(e) {
          ...
          return e ? ((!(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]) && (e = encodeURI(e)), t && (t = `sandbox="${t}"`), `<iframe ${t} id="${j()}"\n      frameborder="0"\n      allowtransparency="true"\n      marginheight="0" marginwidth="0"\n      width="0" hspace="0" vspace="0" height="0"\n      style="height:0px;width:0px;display:none;"\n      scrolling="no"\n      src="${e}">\n    </iframe>`) : ""
        }
        ...
        function mt(e, t) {
          ...
          for (let r = 0; r < n.length; r++) {
            ...
            const o = t[i];
            fe(o) ? (e[i] || (e[i] = {}), mt(e[i], o)) : Array.isArray(o) ? Array.isArray(e[i]) ? o.forEach((t => {
        ...
        function ht(e) {
          let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
            n = function(e, t) {
              if (ce(Math.imul)) return Math.imul(e, t);
              var n = (4194303 & e) * (t |= 0);
        ...
        function Ot(e, t) {
          le(e.nurl) && "" !== e.nurl && (e.nurl = e.nurl.replace(/\${AUCTION_PRICE}/, t), Ie(e.nurl))
        }
        const Bt = function() {
          let e;
          return function() {
      ...
      63895: (e, t, n) => {
        ...
        const f = (0, o.A_)("sync", (function(e, t, n, o, s) {
          if (n && (s || o !== a)) {
            ...
            return t || n || !e.vastXml || e.vastUrl ? !(!e.vastUrl && !e.vastXml) : ((0, r.logError)('\n        This bid contains only vastXml and will not work when a prebid cache url is not specified.\n        Try enabling either prebid cache with pbjs.setConfig({ cache: {url: "..."} });\n        or local cache with pbjs.setConfig({ cache: { useLocal: true }});\n      '), !1)
          }
      ...
      68693: (e, t, n) => {
        ...
        function l(e) {
          ...
          return i.$W.getConfig("cache.vasttrack") && (s.bidder = e.bidder, s.bidid = e.requestId, s.aid = e.auctionId), null != r && (s.timestamp = r.getAuctionStart()), "string" == typeof e.customCacheKey && "" !== e.customCacheKey && (s.key = e.customCacheKey), s
        }

        function u(e) {
          return e.vastXml ? e.vastXml : (t = e.vastUrl, n = e.vastImpUrl, `<VAST version="3.0">\n    <Ad>\n      <Wrapper>\n        <AdSystem>prebid.org wrapper</AdSystem>\n        <VASTAdTagURI><![CDATA[${t}]]></VASTAdTagURI>\n        ${(n=n&&(Array.isArray(n)?n:[n]))?n.map((e=>`<Impression><![CDATA[${e}]]></Impression>`)).join(""):""}\n        <Creatives></Creatives>\n      </Wrapper>\n    </Ad>\n  </VAST>`);
          var t, n
        }
        ...
        function h(e) {
          ...
          m.store(t, (function(n, r) {
            ...
            n ? (o = n, (0, s.logError)(`Failed to save to the video cache: ${o}. Video bids will be discarded:`, t)) : e.length !== r.length ? (0, s.logError)(`expected ${e.length} cache IDs, got ${r.length} instead`) : r.forEach(((t, n) => {
              ...
              var c;
              "" === t.uuid ? (0, s.logWarn)("Supplied video cache key was already in use by Prebid Cache; caching attempt was rejected. Video bid must be discarded.") : (p(o, (c = t.uuid, `${i.$W.getConfig("cache.url")}?uuid=${c}`), t.uuid), (0, a.v8)(r, o), d())
            }))
          }))
        }
        let b, y, v;
        i.$W.getConfig("cache", (e => {
          ...
          b = "number" == typeof t.batchSize && t.batchSize > 0 ? t.batchSize : 1, y = "number" == typeof t.batchTimeout && t.batchTimeout > 0 ? t.batchTimeout : 0, t.useLocal && !v && (v = o.n.onExpiry((e => {
        ...
        const E = function() {
          ...
          return function(o, s, a) {
            const d = y > 0 ? e : i;
            n[n.length - 1].length >= b && n.push([]), n[n.length - 1].push({
              auctionInstance: o,
              bidResponse: s,
              afterBidAdded: a
            }), r || (r = !0, d((() => {
      ...
      30043: (t, e, n) => {
        ...
        class c {
          ...
          then(t, e) {
            ...
            let e;
            return this.then((n => (e = n, t())), (n => (e = this.constructor.reject(n), t()))).then((() => e))
          }
          static #n(t, e, n) {
            let s = t.length;
        ...
        function t(o, n) {
          return function() {
            ...
            for (let n, i, s = 0; s < e.length; s++) {
              ...
              if (o.setCookie(t, "1", void 0, void 0, u), i = o.getCookie(t), o.setCookie(t, "", "Thu, 01 Jan 1970 00:00:01 GMT", void 0, u), "1" !== i) return n;
              n = u
            }
          }
        }
            ...
            null == n && (n = function(n, t) {
              ...
              return (0, o.Ak)(n, (function(n, o) {
                return t().then((t => {
                  ...
                  !r || s && e.has(r) || (e.add(r), (0, a.logWarn)(r.message, ...r.args || [])), n.call(this, o)
                })).catch((t => {
                  (0, a.logError)(`${t?.message} Canceling auction as per consentManagement config.`, ...t?.args || []), n.stopTiming(), "function" == typeof o.bidsBackHandler ? o.bidsBackHandler() : (0, a.logError)("Error executing bidsBackHandler")
                }))
              }))
            }(l, (() => t())), (0, s.m)().requestBids.before(n, 50), i.U3.before(D), (0, a.logInfo)(`${c} consentManagement module has been activated...`))
          }
          return function(o) {
            if (o = o?.[l], !o || "object" != typeof o) return (0, a.logWarn)(C("config not defined, exiting consent manager module")), null != n && ((0, s.m)().requestBids.getHooks({
              hook: n
            }).remove(), i.U3.getHooks({
              hook: D
            }).remove(), n = null), {};
            let T, k;
            (0, a.isStr)(o.cmpApi) ? T = o.cmpApi: (T = f, (0, a.logInfo)(C(`config did not specify cmp.  Using system default setting (${f}).`))), (0, a.isNumber)(o.timeout) ? k = o.timeout : (k = p, (0, a.logInfo)(C(`config did not specify timeout.  Using system default setting (${p}).`)));
            const w = (0, a.isNumber)(o.actionTimeout) ? o.actionTimeout : null;
            let y;
            "static" === T ? (0, a.isPlainObject)(o.consentData) ? (e = o.consentData, k = null, y = () => new r.U9((n => n(u.setConsentData(m(e)))))) : (0, a.logError)(C("config with cmpApi: 'static' did not specify consentData. No consents will be available to adapters.")) : d.hasOwnProperty(T) ? y = d[T] : (u.setConsentData(null), (0, a.logWarn)(`${c} CMP framework (${T}) is not a supported framework.  Aborting consentManagement module and resuming auction.`), y = () => r.U9.resolve());
            const H = () => function(n) {
              let t, {
                name: e,
              ...
              return o.enable(), new Promise(((n, l) => {
                let c, u = !1;

                function m(a) {
                  null != t && clearTimeout(t), t = null != a ? setTimeout((() => {
                    const t = o.getConsentData() ?? (u ? c : i()),
                      a = "timeout waiting for " + (u ? "user action on CMP" : "CMP to load");
                    o.setConsentData(t), n({
                      consentData: t,
                      error: new Error(`${e} ${a}`)
                    })
                  }), a) : null
      ...
      25246: (t, n, e) => {
        ...
        function d() {
          const t = s.mW.getConsentData(),
            n = {};
          return t && ("boolean" == typeof t.gdprApplies && (n.gdpr = Number(t.gdprApplies)), t.consentString && (n.gdpr_consent = t.consentString), t.addtlConsent && (n.addtl_consent = t.addtlConsent)), n
        }
      }
    }
  ]);
            ...
            l.push(a(o, u, function(e, n, t) {
              ...
              return function() {
                if (i().some((n => e.includes(n)))) {
                  ...
                  if (![1, 2].includes(e.Version)) return {
                    allow: !1,
    ...
    [85946], {
      42986: (e, t, n) => {
        ...
        function C(e, t) {
          ...
          return n || (n = String(Date.now()), e.setDataInLocalStorage(t, n, null)), n
        }
        ...
        function S(e, t) {
          ...
          try {
            const r = I(e, t);
            let i, o = 0;
            r && r.value && Date.now() - r.created < n && (o = r.value, i = r.created);
            const d = o + 1;
            return h(e, t, d, i), d
          } catch (e) {
            return 0
        ...
        function v() {
          ...
          return function(t, n) {
            ...
            const c = [],
              ...
              {
                gppString: m,
                applicableSections: f
              } = a,
              b = s.$W.getConfig("coppa") ? 1 : 0,
              h = n.filter((e => (0, i.A)(e, "body.cid"))).map((e => e.body.cid)).filter(r.uniques);
            ...
            return m && f?.length && (I += "&gpp=" + encodeURIComponent(m), I += "&gpp_sid=" + encodeURIComponent(f.join(","))), u && e.iframeSyncUrl && c.push({
              type: "iframe",
        ...
        function $(e, t, n, o, s, c, u, l, m) {
          ...
          const q = function(e) {
              ...
              let r = 0,
                i = 0;
              if (n > 0)
                for (; i < n;) r = (r << 5) - r + e.charCodeAt(i++) | 0;
              return t + r
            }(t),
            x = (0, r.isFn)(m) ? m(q, e) : {},
            z = function(e, t) {
              ...
              const r = `u_${t}`,
                ...
                o = I(e, r);
              let a;
              return !o || !o.value || i - o.created > n ? (a = `${t}_${i.toString()}`, h(e, r, a)) : a = o.value, a
            }(c, q),
            _ = g(f),
            O = a.u.get(l, "storageAllowed"),
            E = (0, i.A)(e, "ortb2Imp.ext.gpid") || (0, i.A)(e, "ortb2Imp.ext.data.pbadslot", ""),
            W = (0, i.A)(o, "ortb2.site.cat", []),
            j = (0, i.A)(o, "ortb2.site.pagecat", []),
            F = (0, i.A)(o, "ortb2.site.content.data", []),
            L = (0, i.A)(o, "ortb2.user.data", []),
            P = (0, i.A)(o, "ortb2.site.content.language") || document.documentElement.lang,
            M = (0, i.A)(o, "ortb2.regs.coppa", 0),
            k = (0, i.A)(o, "ortb2.device", {});
          ...
          const B = (0, i.A)(o, "ortb2.device.sua");
          if (B && (X.sua = B), o.gdprConsent && (o.gdprConsent.consentString && (X.gdprConsent = o.gdprConsent.consentString), void 0 !== o.gdprConsent.gdprApplies && (X.gdpr = o.gdprConsent.gdprApplies ? 1 : 0)), o.uspConsent && (X.usPrivacy = o.uspConsent), o.gppConsent ? (X.gppString = o.gppConsent.gppString, X.gppSid = o.gppConsent.applicableSections) : o.ortb2?.regs?.gpp && (X.gppString = o.ortb2.regs.gpp, X.gppSid = o.ortb2.regs.gpp_sid), o.paapi?.enabled) {
            const e = (0, i.A)(o, "ortb2Imp.ext.ae");
            e && (X.fledge = e)
          }
          if ((0, i.A)(v, "video.api", []).includes(7)) {
            const e = (0, i.A)(o, "ortb2.source.ext");
            e?.omidpv && (X.omidpv = e.omidpv), e?.omidpn && (X.omidpn = e.omidpn)
          }
          const N = (0, i.A)(o, "ortb2.regs.ext.dsa");
          return N && (X.dsa = N), (0, r._each)(T, ((e, t) => {
            X["ext." + t] = e
          })), X
        }
        ...
        function U(e, t, n, i, d, a) {
          function u(r, o, a, s, c) {
            const {
              params: u
            } = r, p = l(u), g = m(u), f = $(r, o, a, s, c, n, d, i, t);
            return {
              method: "POST",
          ...
          return function(p, g) {
            const f = g.refererInfo.page || g.refererInfo.topmostLocation,
              ...
              I = [];
            if (h) {
              const a = p.filter((e => (0, r.isArray)(e.mediaTypes) ? e.mediaTypes.includes(c.D4) : void 0 !== e.mediaTypes[c.D4]));
              if (a.length > 0) {
                const c = function(a, c, u, p) {
                  const {
                    params: g
                  } = a[0], f = l(g), b = m(g), h = a.map((e => {
                    const o = (0, r.parseSizesInput)(e.sizes);
                    return $(e, u, o, c, p, n, d, i, t)
                  })), I = Math.min(20, s.$W.getConfig(`${i}.chunkSize`) || 10);
                  return (0, o.i)(h, I).map((t => ({
                    method: "POST",
              ...
              p.filter((e => void 0 !== e.mediaTypes[c.G_])).forEach((e => {
                const t = (0, r.parseSizesInput)(e.sizes),
                  n = u(e, f, t, g, b);
                I.push(n)
              }))
            } else p.forEach((e => {
      ...
      37668: (e, t, n) => {
        ...
        const d = (e, t) => ({
          ...
          buildRequests: function(n, i) {
            ...
            return r.params = b(s, i), r.bids = y(n, i), {
              method: "POST",
              url: f(o, a, t),
              data: r
            }
          ...
          getUserSyncs: function(e, t) {
            const n = [];
            for (const s of t)
              if (e.iframeEnabled && (0, i.A)(s, "body.params.userSyncURL") && n.push({
                  type: "iframe",
                  url: (0, i.A)(s, "body.params.userSyncURL")
                }), e.pixelEnabled && (0, r.isArray)((0, i.A)(s, "body.params.userSyncPixels"))) {
          ...
          onBidWon: function(e) {
            null != e && ((0, r.logInfo)("onBidWon:", e), e.hasOwnProperty("nurl") && e.nurl.length > 0 && (0, r.triggerPixel)(e.nurl))
          }
        });

        function p(e) {
          const t = (0, i.A)(e, "mediaTypes");
          return (0, r.isPlainObject)(t) ? Object.keys(t) : []
        }
        ...
        function c(e) {
          ...
          return (0, r.isPlainObject)(i) && "USD" === i.currency && i.floor ? i.floor : 0
        }
        ...
        function u(e) {
          ...
          const n = p(e),
            s = n[0];
          return 1 === n.length && (0, i.A)(e, `mediaTypes.${s}.sizes`) ? t = e.mediaTypes[s].sizes : (0, r.isArray)(e.sizes) && e.sizes.length > 0 && (t = e.sizes), t
        }
        ...
        function m(e) {
          ...
          return e.nodes.forEach((e => {
            t += "!", t += `${l(e.asi)},`, t += `${l(e.sid)},`, t += `${l(e.hp)},`, t += `${l(e.rid)},`, t += `${l(e.name)},`, t += `${l(e.domain)}`
          })), t
        }
        ...
        function g(e, t) {
          ...
          const n = "include" === e.filter,
            i = (0, r.isArray)(e.bidders) ? e.bidders : [t];
          return n && (0, r.contains)(i, t)
        }
        ...
        function y(e, t) {
          ...
          return e.length && e.forEach((e => {
            n.push(function(e, t) {
              ...
              const a = {
                  mediaType: o.join(","),
                  adUnitCode: (0, r.getBidIdParameter)("adUnitCode", e),
                  sizes: u(e),
                  floorPrice: Math.max(c(e), n.floorPrice),
                  bidId: (0, r.getBidIdParameter)("bidId", e),
                  loop: e.auctionsCount || 0,
                  bidderRequestId: (0, r.getBidIdParameter)("bidderRequestId", e),
              ...
              l && (a.placementId = l);
              const g = (0, i.A)(e, "ortb2.device.sua");
              g && (a.sua = g);
              const f = (0, i.A)(e, "ortb2.regs.coppa");
              f && (a.coppa = 1);
              if (o.includes(s.G_)) {
                const t = (0, i.A)(e, "mediaTypes.video.playbackmethod");
                let n;
                (0, r.isArray)(t) && (0, r.isInteger)(t[0]) ? n = t[0]: (0, r.isInteger)(t) && (n = t), n && (a.playbackMethod = n);
                const s = (0, i.A)(e, "mediaTypes.video.placement");
                s && (a.placement = s);
                const o = (0, i.A)(e, "mediaTypes.video.minduration");
                o && (a.minDuration = o);
                ...
                l && (a.mimes = l);
                const g = (0, i.A)(e, "mediaTypes.video.api");
                g && (a.api = g)
              }
              if (o.includes(s.s6)) {
            ...
            banner: {
              fn: function(e, t, r) {
                ...
                if (n) {
                  ...
                  n.sizes && null == t.ortb2Imp?.banner?.format && (r.format = (0, i.sizesToSizeTuples)(n.sizes).map(i.sizeTupleToRtbSize)), n.hasOwnProperty("pos") && (r.pos = n.pos), e.banner = (0, i.mergeDeep)(r, e.banner)
                }
              }
            },
            pbadslot: {
            ...
            props: {
              fn(e, t, r) {
                Object.entries({
                  ...
                  let [r, n] = t;
                  return e[r] = n
                })), e.meta || (e.meta = {}), t.adomain && (e.meta.advertiserDomains = t.adomain), t.ext?.dsa && (e.meta.dsa = t.ext.dsa), t.cat && (e.meta.primaryCatId = t.cat[0], e.meta.secondaryCatIds = t.cat.slice(1)), t.attr && (e.meta.attr = t.attr), t.ext?.eventtrackers && (e.eventtrackers = (e.eventtrackers ?? []).concat(t.ext.eventtrackers))
              }
            }
          }
        };
      ...
      20981: (e, t, i) => {
        ...
        const v = {
              ...
              fn: function(e, t, i) {
                ...
                if (r.aliasRegistry[t.bidderCode]) {
                  ...
                  if (!i || !i.getSpec().skipPbsAliasing) {
                    (0, p.J)(e, `ext.prebid.aliases.${t.bidderCode}`, r.aliasRegistry[t.bidderCode]);
                    const d = o.$W.getConfig(`gvlMapping.${t.bidderCode}`) || i?.getSpec?.().gvlid;
                    d && (0, p.J)(e, `ext.prebid.aliasgvlids.${t.bidderCode}`, d)
                  }
                }
              }
            }
          ...
          [d.WR]: {
            ...
            bidderCode: {
              fn(e, t, i) {
                e.bidderCode = i.seatbid.seat, e.adapterCode = (0, n.A)(t, "ext.prebid.meta.adaptercode") || i.bidRequest?.bidder || e.bidderCode
              }
            },
            pbsBidId: {
              fn(e, t) {
                const i = (0, n.A)(t, "ext.prebid.bidid");
                (0, s.isStr)(i) && (e.pbsBidId = i)
              }
            },
            adserverTargeting: {
              fn(e, t) {
                const i = (0, n.A)(t, "ext.prebid.targeting");
                (0, s.isPlainObject)(i) && (e.adserverTargeting = i)
              }
            },
            extPrebidMeta: {
              fn(e, t) {
                e.meta = (0, s.mergeDeep)({}, (0, n.A)(t, "ext.prebid.meta"), e.meta)
              }
            },
            pbsWinTrackers: {
              fn: function(e, t) {
            ...
            serverSideStats: {
              fn(e, t, i) {
                Object.entries({
                  ...
                  let [r, d] = e;
                  const s = (0, n.A)(t, `ext.${r}.${i.bidderRequest.bidderCode}`);
                  s && (i.bidderRequest[d] = s, i.bidRequests.forEach((e => e[d] = s)))
                }))
              }
            }
          }
        ...
        var g = i(89766);
        const m = (0, s.memoize)((() => (0, r.U)((0, g.T)(), v, (0, d.yB)(d.e4))))
      },
      25825: (e, t, i) => {
        i.d(t, {
          o: () => s,
        ...
        function s(e, t, i) {
          let s = i.mediaType;
          s || (s = d.X.hasOwnProperty(t.mtype) ? d.X[t.mtype] : t.ext?.prebid?.type, n.hasOwnProperty(s) || (s = r.D4)), e.mediaType = s
        }
      },
      43323: (e, t, i) => {
        i.d(t, {
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [90467], {
      6036: (e, s, n) => {
        ...
        function a(e, s, n) {
          const a = [];
          return (0, r.isFn)(e.getFloor) && ((0, i.A)(e, `mediaTypes.${n}.${n===o.G_?"playerSize":"sizes"}`) || []).forEach((o => {
            const r = e.getFloor({
              currency: s || "USD",
              mediaType: n,
              size: o
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [99498], {
      90011: (e, r, i) => {
        ...
        const t = {
          mimes: e => Array.isArray(e) && e.length > 0 && e.every((e => "string" == typeof e)),
          minduration: e => (0, a.isInteger)(e),
          maxduration: e => (0, a.isInteger)(e),
          protocols: e => Array.isArray(e) && e.every((e => e >= 1 && e <= 10)),
          w: e => (0, a.isInteger)(e),
          h: e => (0, a.isInteger)(e),
          startdelay: e => (0, a.isInteger)(e),
          linearity: e => -1 !== [1, 2].indexOf(e),
          skip: e => -1 !== [0, 1].indexOf(e),
          skipmin: e => (0, a.isInteger)(e),
          skipafter: e => (0, a.isInteger)(e),
          sequence: e => (0, a.isInteger)(e),
          battr: e => Array.isArray(e) && e.every((e => e >= 1 && e <= 17)),
          maxextended: e => (0, a.isInteger)(e),
          minbitrate: e => (0, a.isInteger)(e),
          maxbitrate: e => (0, a.isInteger)(e),
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [51912], {
      20947: (e, t, s) => {
        ...
        class c {
          constructor(e, t, s, r) {
            this._baseUrl = e.baseUrl, this._clientVersion = t, this._logInfo = function() {
              for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
              return l(s, ...t)
            }, this._logWarn = r
          }
          ...
          callRefreshApi(e) {
            ...
            return this._logInfo("Sending refresh request", e), (0, r.RD)(t, {
              success: t => {
                try {
                  if (e.refresh_response_key) {
                    ...
                    window.crypto.subtle.importKey("raw", this.createArrayBuffer(atob(e.refresh_response_key)), {
                      ...
                      this._logInfo("Imported decryption key"), window.crypto.subtle.decrypt({
                        name: "AES-GCM",
                        iv: r.slice(0, 12),
                        tagLength: 128
                      }, e, r.slice(12)).then((e => {
        ...
        class d {
          constructor(e, t, s, r) {
            this._storage = e, this._preferLocalStorage = t, this._storageName = s, this._logInfo = function() {
          ...
          getStoredValueWithFallback() {
            ...
            if (i) {
              if ("string" == typeof i) {
                const t = r();
                if (t && "object" == typeof t) return this._logInfo(`${e} contained a basic token, but found a refreshable token fallback. Copying the fallback value to ${e}.`), s(t), t
              }
            } else {
              const t = r();
              if (t) return this._logInfo(`${e} was empty, but found a fallback value.`), "object" == typeof t && (this._logInfo(`Copying the fallback value to ${e}.`), s(t)), t
            }
            return i
          }
        }
        ...
        let h;
        {
          ...
          h = {
            isCSTGOptionsValid(e, t) {
              if ("object" != typeof e || null === e) return t('CSTG is not being used, but is included in the Prebid.js bundle. You can reduce the bundle size by passing "--disable UID2_CSTG" to the Prebid.js build.'), !1;
              const s = e;
              ...
              return r.test(s.serverPublicKey) ? "string" != typeof s.subscriptionId ? (t("CSTG opts.subscriptionId must be a string"), !1) : 0 !== s.subscriptionId.length || (t("CSTG opts.subscriptionId is empty"), !1) : (t(`CSTG opts.serverPublicKey must match the regular expression ${r}`), !1)
            },
            getValidIdentity(e, s) {
              if (e.emailHash) return t.isBase64Hash(e.emailHash) ? {
                email_hash: e.emailHash
              } : void s("CSTG opts.emailHash is invalid");
              if (e.phoneHash) return t.isBase64Hash(e.phoneHash) ? {
            ...
            isStoredTokenInvalid(e, t, s, r) {
              if (t) {
                ...
                if (!this.isStoredTokenFromSameIdentity(t, r)) return s("CSTG supplied new identity - ignoring stored value.", t.originalIdentity, e), !0
              }
              return !1
            },
            ...
            isStoredTokenFromSameIdentity: (e, t) => !!e.originalIdentity && (0, i.cyrb53Hash)(t, e.originalIdentity.salt) === e.originalIdentity.identity,
            encodeOriginalIdentity(e) {
              const t = Object.values(e)[0],
                s = Math.floor(Math.random() * Math.pow(2, 32));
              return {
                identity: (0, i.cyrb53Hash)(t, s),
                salt: s
              }
            }
          };
          class t {
            ...
            static normalizeEmail(e) {
              ...
              const {
                address: r,
                domain: i
              } = s, n = this.isGmail(i), o = this.normalizeAddressPart(r, n, n);
              return o ? `${o}@${i}` : void 0
            }
          ...
          class s {
            constructor(e, t, s) {
              this._baseUrl = e.baseUrl, this._serverPublicKey = e.cstg.serverPublicKey, this._subscriptionId = e.cstg.subscriptionId, this._logInfo = function() {
            ...
            async generateToken(e) {
              ...
              const s = await n.build(this.stripPublicKeyPrefix(this._serverPublicKey)),
                ...
                i = Date.now(),
                {
                  iv: o,
                  ciphertext: a
                } = await s.encrypt(r.encode(JSON.stringify(t)), r.encode(JSON.stringify([i]))),
            ...
            async callCstgApi(e, t) {
              ...
              return this._logInfo("Sending CSTG request", e), (0, r.RD)(s, {
                success: async (e, s) => {
                  try {
        ...
        function p(e, t, s, r) {
          ...
          c ? (i("Module is using client-side token generation."), n = null) : e.paramToken ? (n = e.paramToken, i("Read token from params", n)) : e.serverCookieName && (n = a.readProvidedCookie(e.serverCookieName), i("Read token from server-supplied cookie", n));
          let p = a.getStoredValueWithFallback();
          if (i("Loaded module-stored tokens:", p), p && "string" == typeof p) {
            if (!n && !c) return i("Returning legacy cookie value."), {
              id: p
            };
            i("Discarding superseded legacy cookie."), p = null
          }
          if (n && p && p.originalToken?.advertising_token !== n.advertising_token && (i("Server supplied new token - ignoring stored value.", p.originalToken?.advertising_token, n.advertising_token), p = null), c) {
            const t = h.getValidIdentity(e.cstg, r);
            if (t && (p && h.isStoredTokenInvalid(t, p, i, r) && (p = null), !p || Date.now() > p.latestToken.refresh_expires)) {
              const s = h.generateTokenAndStore(e.apiBaseUrl, e.cstg, t, a, i, r);
              return i("Generate token using CSTG"), {
                callback: e => {
                  s.then((t => {
                    i("Token generation responded, passing the new token on.", t), e(t)
                  }))
                }
              }
            }
          ...
          const g = !p?.latestToken || n && n.identity_expires > p.latestToken.identity_expires,
            y = g ? n : p.latestToken;
          if (i("UID2 module selected latest token", g, y), !y || Date.now() > y.refresh_expires) return i("Newest available token is expired and not refreshable."), {
            id: null
          };
          if (Date.now() > y.identity_expires) {
            ...
            return i("Token is expired but can be refreshed, attempting refresh."), {
              callback: e => {
                t.then((t => {
                  i("Refresh reponded, passing the updated token on.", t), e(t)
                }))
              }
            }
          }
          Date.now() > y.refresh_from && (i("Refreshing token in background with low priority."), u(e.apiBaseUrl, y, e.clientId, a, i, r));
          const f = {
            originalToken: n ?? p?.originalToken,
            latestToken: y
          };
          return c && (f.originalIdentity = p?.originalIdentity), a.storeValue(f), {
            id: f
          }
        }
        ...
        const y = {
          ...
          getId(e) {
            ...
            const {
              ...
              pid: h,
              hem: S
            } = o, T = S || window._33across?.hem?.sha256;
            return {
              callback(e) {
                (0, s.g4)(1e4)(c, {
                  success(o) {
                    ...
                    try {
                      s = function(e) {
                        return e.succeeded ? e.data.envelope ? {
                          ...
                          fp: e.data.fp,
                          tp: e.data.tp
                        } : ((0, n.logMessage)(`${l}: No envelope was received`), {}) : ("Cookied User" == e.error ? (0, n.logMessage)(`${l}: Unsuccessful response`.concat(" ", e.error)) : (0, n.logError)(`${l}: Unsuccessful response`.concat(" ", e.error)), {})
                      }(JSON.parse(o))
                    } catch (e) {
      ...
      63399: (e, i, t) => {
            ...
            function i(i) {
              e[i] = {}, e[i].bidStorage = new Set, e[i].queueDispatcher = function(e) {
                ...
                return function(n, a, o, d) {
                  ...
                  clearTimeout(i), d ? t = 1 : t === T ? (t = 1, u()) : (t++, i = setTimeout(u, e))
                }
              }(b), e[i].initialCacheKey = (0, a.generateUUID)()
            }
            return {
              addBid: function(t) {
              ...
              setupInitialCacheKey: function(i) {
                e[i.auctionId] || (e[i.auctionId] = {}, e[i.auctionId].initialCacheKey = (0, a.generateUUID)())
              },
        ...
        function y(e, i) {
          let t = C.getInitialCacheKey(e),
            n = (0, o.A)(e, "video.durationBucket");
          const a = function(e) {
            let i;
            if (s.$W.getConfig("adpod.prioritizeDeals") && (0, o.A)(e, "video.dealTier")) {
              const t = s.$W.getConfig(`adpod.dealTier.${e.bidderCode}.prefix`);
              i = t ? t + (0, o.A)(e, "video.dealTier") : (0, o.A)(e, "video.dealTier")
            } else {
              const t = (0, d.mO)(e);
              i = (0, d.ZV)(t)(e)
            }
          ...
          let r;
          if (i) {
            r = `${a}_${(0,o.A)(e,"meta.adServerCatId")}_${n}s`
          } else r = `${a}_${n}s`;
          e.adserverTargeting || (e.adserverTargeting = {}), e.adserverTargeting[v] = r, e.adserverTargeting[m] = t, e.videoCacheKey = t, e.customCacheKey = `${r}_${t}`
        }

        function S(e, i, t) {
          ! function(e) {
            for (let i = 0; i < e.length; i++) C.removeBid(e[i])
          }(i), (0, l.M_)(i, (function(n, o) {
            if (n)(0, a.logWarn)(`Failed to save to the video cache: ${n}. Video bid(s) must be discarded.`);
            else
              for (let n = 0; n < o.length; n++) "" !== o[n].uuid ? (0, d.v8)(e, i[n]) : (0, a.logInfo)(`Detected a bid was not cached because the custom key was already registered.  Attempted to use key: ${i[n].customCacheKey}. Bid was: `, i[n]), t()
          }))
        }
        ...
        function A(e, i, t, n, r) {
          if (r && r.context === g.LM) {
            ...
            !(0, o.A)(t, "meta.adServerCatId") && e ? ((0, a.logWarn)("Detected a bid without meta.adServerCatId while setConfig({adpod.brandCategoryExclusion}) was enabled.  This bid has been rejected:", t), n()) : !1 === s.$W.getConfig("adpod.deferCaching") ? (C.addBid(t), y(t, e), function(e, i, t) {
              let n = C.getBids(i);
              if (n) {
                let a = Array.from(n),
                ...
                o(e, a, t, r)
              } else(0, a.logWarn)("Attempted to cache a bid from an unknown auction. Bid:", i)
            }(i, t, n)) : (C.setupInitialCacheKey(t), y(t, e), (0, d.v8)(i, t), n())
          } else e.call(this, i, t, n, r)
        }

        function I(e, i) {
          let t = i.filter((e => {
            let i = (0, o.A)(e, "mediaTypes"),
              t = (0, o.A)(i, "video");
            if (t && t.context === g.LM) {
              if (Object.keys(i).length > 1) return (0, a.logWarn)(`Detected more than one mediaType in adUnitCode: ${e.code} while attempting to define an 'adpod' video adUnit.  'adpod' adUnits cannot be mixed with other mediaTypes.  This adUnit will be removed from the auction.`), !1;
              let n = `Detected missing or incorrectly setup fields for an adpod adUnit.  Please review the following fields of adUnitCode: ${e.code}.  This adUnit will be removed from the auction.`,
                o = !!(t.playerSize && ((0, a.isArrayOfNums)(t.playerSize, 2) || (0, a.isArray)(t.playerSize) && t.playerSize.every((e => (0, a.isArrayOfNums)(e, 2)))) || t.sizeConfig),
                d = !!(t.adPodDurationSec && (0, a.isNumber)(t.adPodDurationSec) && t.adPodDurationSec > 0),
                r = !!(t.durationRangeSec && (0, a.isArrayOfNums)(t.durationRangeSec) && t.durationRangeSec.every((e => e > 0)));
              if (!o || !d || !r) return n += o ? "" : "\nmediaTypes.video.playerSize", n += d ? "" : "\nmediaTypes.video.adPodDurationSec", n += r ? "" : "\nmediaTypes.video.durationRangeSec", (0, a.logWarn)(n), !1
            }
            return !0
          }));
          i = t, e.call(this, i)
        ...
        function D(e, i, t, n, d) {
          if (d === g.LM) {
            let t = !0;
            if (s.$W.getConfig("adpod.brandCategoryExclusion") && !(0, o.A)(i, "meta.primaryCatId") && (t = !1), (0, o.A)(i, "video"))
              if ((0, o.A)(i, "video.context") && i.video.context === g.LM || (t = !1), !(0, o.A)(i, "video.durationSeconds") || i.video.durationSeconds <= 0) t = !1;
              else {
                let e = function(e, i) {
                  let t = (0, o.A)(i, "video.durationSeconds"),
                    n = e.durationRangeSec;
                  if (n.sort(((e, i) => e - i)), e.requireExactDuration) {
                    if (!(0, f.I6)(n, (e => e === t))) return (0, a.logWarn)("Detected a bid with a duration value not part of the list of accepted ranges specified in adUnit.mediaTypes.video.durationRangeSec.  Exact match durations must be used for this adUnit. Rejecting bid: ", i), !1;
                    i.video.durationBucket = t
                  } else {
                    let e = Math.max(...n);
                    if (!(t <= e + 2)) return (0, a.logWarn)("Detected a bid with a duration value outside the accepted ranges specified in adUnit.mediaTypes.video.durationRangeSec.  Rejecting bid: ", i), !1;
                    {
                      let e = (0, f.I6)(n, (e => e + 2 >= t));
                ...
                e || (t = !1)
              } s.$W.getConfig("cache.url") || !i.vastXml || i.vastUrl || ((0, a.logError)('\n        This bid contains only vastXml and will not work when a prebid cache url is not specified.\n        Try enabling prebid cache with pbjs.setConfig({ cache: {url: "..."} });\n      '), t = !1), e.bail(t)
        ...
        s.$W.getConfig("adpod", (e => function(e) {
          void 0 !== e.bidQueueTimeDelay && ("number" == typeof e.bidQueueTimeDelay && e.bidQueueTimeDelay > 0 ? b = e.bidQueueTimeDelay : (0, a.logWarn)(`Detected invalid value for adpod.bidQueueTimeDelay in setConfig; must be a positive number.  Using default: ${b}`)), void 0 !== e.bidQueueSizeLimit && ("number" == typeof e.bidQueueSizeLimit && e.bidQueueSizeLimit > 0 ? T = e.bidQueueSizeLimit : (0, a.logWarn)(`Detected invalid value for adpod.bidQueueSizeLimit in setConfig; must be a positive number.  Using default: ${T}`))
        }(e.adpod))), (0, c.pT)((0, c.Yn)("callPrebidCache"), A), (0, c.pT)(r.Z, I), (0, c.pT)(u.E2, D);
        const B = {
          ...
          getTargeting: function() {
            ...
            if (!i) return void(0, a.logError)("No callback function was defined in the getTargeting call.  Aborting getTargeting().");
            e = e || [];
            const t = function(e) {
                return h.n.getAdUnits().filter((e => (0, o.A)(e, "mediaTypes.video.context") === g.LM)).filter((i => !(e.length > 0) || -1 != e.indexOf(i.code)))
              }(e),
            ...
            if (c = d || u ? function(e) {
              ...
              }(c) : c, s.$W.getConfig("adpod.prioritizeDeals")) {
              let [e, i] = c.reduce(((e, i) => {
                let t = (0, o.A)(i, "video.dealTier"),
              ...
              i.sort(E), e.sort(E), c = i.concat(e)
            } else c.sort(E);
            let f = {};
            if (!1 === u) t.forEach((e => {
              let i = [],
                t = (0, o.A)(e, "mediaTypes.video.adPodDurationSec");
              c.filter((i => i.adUnitCode === e.code)).forEach(((e, n, a) => {
                e.video.durationBucket <= t && (i.push({
                  [v]: e.adserverTargeting[v]
                }), t -= e.video.durationBucket), n === a.length - 1 && i.length > 0 && i.push({
              ...
              t.forEach((i => {
                ...
                function(e, i) {
                  ...
                  if (e) i(e, null);
                    ...
                    let e = (0, a.groupBy)(t, "adUnitCode");
        ...
        Object.freeze(B), (0, c.xG)("adpod", (function() {
          (0, a.isPlainObject)(arguments.length <= 0 ? void 0 : arguments[0]) ? function(e, i) {
            for (let t in i) e[t] = i[t]
          }(arguments.length <= 0 ? void 0 : arguments[0], B) : (0, a.logError)("Adpod module needs plain object to share methods with submodule")
        })), (0, n.E)("adpod")
      }
    },
    e => {
      e.O(0, [60802, 37769, 12139, 51085], (() => {
        return i = 63399, e(e.s = i);
        var i
      }));
      e.O()
    }
      ...
      96345: (e, n, t) => {
        ...
        class h {
          ...
          init(e) {
            ...
            return this.initialized || (e.gppVersion !== this.apiVersion && (0, i.logWarn)(`Unrecognized GPP CMP version: ${e.apiVersion}. Continuing using GPP API version ${this.apiVersion}...`), this.initialized = !0, this.cmp({
              command: "addEventListener",
              callback: (e, n) => {
                null == n || n ? "error" === e?.pingData?.cmpStatus ? this.#n(new g('CMP status is "error"; please check CMP setup', e)) : this.isCMPReady(e?.pingData || {}) && ["sectionChange", "signalStatus"].includes(e?.eventName) && this.#e(this.updateConsent(e.pingData)) : this.#n(new g("Received error response from CMP", e)), null == o.ad.getConsentData() || null == e?.pingData || this.isCMPReady(e.pingData) || o.ad.setConsentData(null)
              }
            })), n
          }
          refresh() {
          ...
          updateConsent(e) {
            return new l.U9((n => {
              if (null == e || (0, i.isEmpty)(e)) throw new g("Received empty response from CMP", e);
              const t = C(e);
        ...
        function C(e) {
          if (null != e?.applicableSections && !Array.isArray(e.applicableSections) || null != e?.gppString && !(0, i.isStr)(e.gppString) || null != e?.parsedSections && !(0, i.isPlainObject)(e.parsedSections)) throw new g("CMP returned unexpected value during lookup process.", e);
          return ["usnatv1", "uscav1"].forEach((n => {
            e?.parsedSections?.[n] && (0, i.logWarn)(`Received invalid section from cmp: '${n}'. Some functionality may not work as expected`, e)
          })), S(e)
        }
        ...
        r.$W.getConfig("consentManagement", (e => function(e) {
          return d = f(e), d.loadConsentData?.()?.catch?.((() => null))
        }(e.consentManagement))), p.w.before((function(e, n) {
          return e(n.then((e => {
            const n = o.ad.getConsentData();
            return n && (Array.isArray(n.applicableSections) && (0, a.J)(e, "regs.gpp_sid", n.applicableSections), (0, a.J)(e, "regs.gpp", n.gppString)), e
          })))
    ...
    [15081], {
      66117: (e, n, t) => {
          ...
          m = {
            iab: function(e) {
              return new Promise(((n, t) => {
                ...
                o || t(new Error("TCF2 CMP not found.")), o.isDirect ? (0, r.logInfo)("Detected CMP API is directly accessible, calling it now...") : (0, r.logInfo)("Detected CMP is outside the current iframe where Prebid.js is located, calling it now..."), o({
                  command: "addEventListener",
                  callback: function(o, s) {
                    if ((0, r.logInfo)("Received a response from CMP", o), s) {
                      try {
                        e(b(o))
                      } catch (e) {}
                      if (!1 === o.gdprApplies || "tcloaded" === o.eventStatus || "useractioncomplete" === o.eventStatus) try {
                        c.mW.setConsentData(b(o)), n()
                      } catch (e) {
                        t(e)
                      }
        ...
        function b(e) {
          if (function() {
              const n = e && "boolean" == typeof e.gdprApplies ? e.gdprApplies : g,
                t = e && e.tcString;
              return !("boolean" == typeof n && (!0 !== n || t && (0, r.isStr)(t)))
        ...
        function D(e) {
          ...
          return e && e.addtlConsent && (0, r.isStr)(e.addtlConsent) && (n.addtlConsent = e.addtlConsent), n.apiVersion = C, n
        }
        const v = (0, l.yq)({
          namespace: "gdpr",
          displayName: "TCF",
        ...
        a.$W.getConfig("consentManagement", (e => function(e) {
          return e = e && (e.gdpr || e.usp || e.gpp ? e.gdpr : e), null != e?.consentData?.getTCData && (e.consentData = e.consentData.getTCData), g = !0 === e?.defaultGdprScope, u = !!e?.dsaPlatform, f = v({
            gdpr: e
          }), f.loadConsentData?.()?.catch?.((() => null))
        }(e.consentManagement))), p.w.before((function(e, n) {
          return e(n.then((e => {
            const n = c.mW.getConsentData();
            return n && ("boolean" == typeof n.gdprApplies && (0, s.J)(e, "regs.ext.gdpr", n.gdprApplies ? 1 : 0), (0, s.J)(e, "user.ext.consent", n.consentString)), u && (0, s.J)(e, "regs.ext.dsa.dsarequired", 3), e
          })))
        })), (0, i.pS)({
          type: i.S3,
          ...
          fn: function(e, n) {
            ...
            t && "string" == typeof t && (0, s.J)(e, "user.ext.ConsentedProvidersSettings.consented_providers", t)
          }
      ...
      86056: (n, t, e) => {
        ...
        const v = {
          iab: function(n) {
            ...
            let o = function() {
              ...
              return {
                consentDataCallback: (o, a) => {
                  a && o.uspString && (n.usPrivacy = o.uspString), n.usPrivacy ? h(n, {
                    onSuccess: t,
                    onError: e
            ...
            s.isDirect ? (0, a.logInfo)("Detected USP CMP is directly accessible, calling it now...") : (0, a.logInfo)("Detected USP CMP is outside the current iframe where Prebid.js is located, calling it now...");
            s({
              command: "getUSPData",
        ...
        function D(n) {
          ...
          function o(o, a) {
            if (null != t && clearTimeout(t), e = !0, r.t6.setConsentData(o), null != n) {
              for (var s = arguments.length, i = new Array(s > 2 ? s - 2 : 0), c = 2; c < s; c++) i[c - 2] = arguments[c];
              n(a, ...i)
            }
          }
          if (!v[P]) return void o(null, `USP framework (${P}) is not a supported framework. Aborting consentManagement module and resuming auction.`);
          const a = {
            onSuccess: o,
            onError: function(n) {
          ...
          v[P](a), e || (0 === b ? h(void 0, a) : t = setTimeout(a.onError.bind(null, "USPAPI workflow exceeded timeout threshold."), b))
        }
        const y = (0, u.Ak)("usp", (function(n, t) {
          var e = this;
          S || U(), D((function(o) {
            if (null != o) {
              for (var s = arguments.length, i = new Array(s > 1 ? s - 1 : 0), c = 1; c < s; c++) i[c - 1] = arguments[c];
              (0, a.logWarn)(o, ...i)
            }
            n.call(e, t)
          }))
        ...
        function U() {
          ...
          S || ((0, a.logInfo)("USPAPI consentManagement module has been activated" + (n ? "" : ` using default values (api: '${P}', timeout: ${b}ms)`)), S = !0, r.t6.enable()), D()
        }
        i.$W.getConfig("consentManagement", (n => function(n) {
          (n = n && n.usp) && "object" == typeof n || (0, a.logWarn)("consentManagement.usp config not defined, using defaults"), n && (0, a.isStr)(n.cmpApi) ? P = n.cmpApi : (P = d, (0, a.logInfo)(`consentManagement.usp config did not specify cmpApi. Using system default setting (${d}).`)), n && (0, a.isNumber)(n.timeout) ? b = n.timeout : (b = 50, (0, a.logInfo)("consentManagement.usp config did not specify timeout. Using system default setting (50).")), "static" === P && ((0, a.isPlainObject)(n.consentData) && (0, a.isPlainObject)(n.consentData.getUSPData) ? (n.consentData.getUSPData.uspString && (m = {
            usPrivacy: n.consentData.getUSPData.uspString
          }), b = 0) : (0, a.logError)("consentManagement config with cmpApi: 'static' did not specify consentData. No consents will be available to adapters.")), U(!0)
        }(n.consentManagement))), (0, l.Yn)("requestBids").before(y, 50), g.w.before((function(n, t) {
          return n(t.then((n => {
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [36050], {
      96480: (e, t, r) => {
        ...
        function U(e) {
          if (!e.params && !e.url) return void(0, f.logError)("A params object or a url is required to use pbjs.adServers.dfp.buildVideoUrl");
          const t = e.adUnit,
            r = e.bid || m.iS.getWinningBids(t.code)[0];
          let n = {};
          if (e.url && (n = (0, f.parseUrl)(e.url, {
              noDecodeWholeURL: !0
            }), (0, f.isEmpty)(e.params))) return function(e, t, r) {
            const n = _(t, e, "search");
            n && (e.search.description_url = n);
            return e.search.cust_params = x(t, r, e.search.cust_params), (0, f.buildUrl)(e)
          }(n, r, e);
          const o = {
              correlator: Date.now(),
          ...
          Object.entries({
            plcmt: () => h?.plcmt,
            min_ad_duration: () => (0, f.isNumber)(h?.minduration) ? 1e3 * h.minduration : null,
            max_ad_duration: () => (0, f.isNumber)(h?.maxduration) ? 1e3 * h.maxduration : null,
            vpos() {
              const e = h?.startdelay;
              if ((0, f.isNumber)(e)) return -2 === e ? "postroll" : -1 === e || e > 0 ? "midroll" : "preroll"
            },
          ...
          }))), (0, f.buildUrl)(Object.assign({}, b.P8, n, {
            search: u
          }))
        }
        ...
        async function C(e, t) {
          try {
            ...
            if (1 != i.length) return (0, f.logWarn)(`Unable to determine unique uuid in ${v}`), e;
            const s = i[0],
              c = t.get(s),
              ...
              }(c), d = n.createCDATASection(l);
            return a.textContent = "", a.appendChild(d), r.serialize(n)
          } catch (t) {
            return (0, f.logWarn)("Unable to process xml", t), e
          }
        }
        c.$W.getConfig("brandCategoryTranslation.translationFile") && (0, u.Yn)("registerAdserver").before((function(e) {
          e.call(this, "dfp")
        })), (0, o.U)("dfp", {
          buildVideoUrl: U,
    ...
    [26497], {
      74263: (e, t, r) => {
        ...
        const h = "id5id",
          ...
          y = {
            ...
            decode(e, t) {
              ...
              (0, n.isPlainObject)(a.euid) && (d.euid = {
              ...
              switch ((0, o.A)(e, "ab_testing.result")) {
                case "control":
                  (0, n.logInfo)(f + "A/B Testing - user is in the Control Group: ID5 ID is NOT exposed"), (0, s.J)(d, "id5id.ext.abTestingControlGroup", !0);
                  break;
                case "error":
                  (0, n.logError)(f + "A/B Testing ERROR! controlGroupPct must be a number >= 0 and <= 1");
                  break;
                case "normal":
                  (0, n.logInfo)(f + "A/B Testing - user is NOT in the Control Group"), (0, s.J)(d, "id5id.ext.abTestingControlGroup", !1)
              }
              return (0, n.logInfo)(f + "Decoded ID", d), d
            },
            getId(e, t, r) {
              if (! function(e) {
                  if (!e || !e.params || !e.params.partner) return (0, n.logError)(f + "partner required to be defined"), !1;
                  const t = e.params.partner;
                  if ("string" == typeof t || t instanceof String) {
                    let r = parseInt(t);
                    if (isNaN(r) || r < 0) return (0, n.logError)(f + "partner required to be a number or a String parsable to a positive integer"), !1;
                    e.params.partner = r
                  } else if ("number" != typeof t) return (0, n.logError)(f + "partner required to be a number or a String parsable to a positive integer"), !1;
                  if (!e.storage || !e.storage.type || !e.storage.name) return (0, n.logError)(f + "storage required to be set"), !1;
                  e.storage.name !== h && (0, n.logWarn)(f + `storage name recommended to be '${h}'.`);
                  return !0
                }(e)) return;
              if (!E(t?.gdpr)) return void(0, n.logInfo)(f + "Skipping ID5 local storage write because no consent given.");
              return {
                callback: function(i) {
                  new v(e, t?.gdpr, r, t?.usp, t?.gpp).execute().then((e => {
                    i(e)
                  })).catch((e => {
                    (0, n.logError)(f + "getId fetch encountered an error", e), i()
                  }))
                }
              }
            },
            extendId: (e, t, r) => E(t?.gdpr) ? ((0, n.logInfo)(f + "using cached ID", r), r && (r.nbPage = I(r)), r) : ((0, n.logInfo)(f + "No consent given for ID5 local storage writing, skipping nb increment."), r),
        ...
        class v {
          ...
          async execute() {
            ...
            try {
              ...
              return (0, n.logError)(f + "Error while performing ID5 external module flow. Continuing with regular flow.", t), this.#r(e)
            }
          }
          #t() {
          ...
          async #i(e) {
            ...
            const t = await e;
            return this.#n().fetchId5Id(t, this.submoduleConfig.params, (0, u.EN)(), this.gdprConsentData, this.usPrivacyData, this.gppData)
          }
          #n() {
          ...
          async #e() {
            ...
            return (0, n.logInfo)(f + "config response received from the server", r), r
          }
          async #o(e) {
            if (void 0 === e) return;
            const t = e.url,
            ...
            return (0, n.logInfo)(f + "extensions response received from the server", s), s
          }
          async #s(e, t) {
            const r = e.url,
              i = e.overrides || {},
            ...
            return (0, n.logInfo)(f + "fetch response received from the server", d), d
          }
          #d() {
            ...
            !t || void 0 === this.gdprConsentData.consentString || (0, n.isEmpty)(this.gdprConsentData.consentString) || (0, n.isEmptyStr)(this.gdprConsentData.consentString) || (a.gdpr_consent = this.gdprConsentData.consentString), void 0 === this.usPrivacyData || (0, n.isEmpty)(this.usPrivacyData) || (0, n.isEmptyStr)(this.usPrivacyData) || (a.us_privacy = this.usPrivacyData), this.gppData && (a.gpp_string = this.gppData.gppString, a.gpp_sid = this.gppData.applicableSections), void 0 === i || (0, n.isEmptyStr)(i) || (a.s = i), void 0 === e.pd || (0, n.isEmptyStr)(e.pd) || (a.pd = e.pd), void 0 === e.provider || (0, n.isEmptyStr)(e.provider) || (a.provider = e.provider);
            const d = e.abTesting || {
              enabled: !1
            };
          ...
          #a(e) {
            try {
              ...
              (0, n.logError)(f + "Error while writing privacy info into local storage.", e)
            }
            return e
          }
        }
        ...
        function E(e) {
          ...
          return !!(!t || r && i)
        }(0, d.bz)("userId", y), (0, i.E)("id5IdSystem")
      }
    },
    e => {
      e.O(0, [60802, 37769, 12139, 51085], (() => {
        return t = 74263, e(e.s = t);
        var t
      }));
      e.O()
    }
    ...
    [53170], {
      77764: (e, t, i) => {
        ...
        function B(e, t, i) {
          ...
          let d = !1;
          n ? (t.bidfloor = n.floor, t.bidfloorcur = n.currency, (0, a.J)(t, "ext.fl", v.PBJS), d = !0) : r && (t.bidfloor = r.floor, t.bidfloorcur = r.currency, (0, a.J)(t, "ext.fl", v.IX), d = !0), d && (i == s.D4 ? ((0, a.J)(t, "banner.ext.bidfloor", t.bidfloor), (0, a.J)(t, "banner.ext.fl", t.ext.fl)) : i == s.G_ ? ((0, a.J)(t, "video.ext.bidfloor", t.bidfloor), (0, a.J)(t, "video.ext.fl", t.ext.fl)) : ((0, a.J)(t, "native.ext.bidfloor", t.bidfloor), (0, a.J)(t, "native.ext.fl", t.ext.fl)))
        }
        ...
        function F(e, t, i) {
          ...
          y.hasOwnProperty(t) ? r.cpm = e.price / y[t] : r.cpm = e.price / 100, r.requestId = e.impid, d && (r.dealId = d), r.netRevenue = true, r.currency = t, r.creativeId = e.hasOwnProperty("crid") ? e.crid : "-", e.mtype != J || (!e.ext || e.ext.vasturl) && e.ext ? e.ext && e.ext.vasturl && (r.vastUrl = e.ext.vasturl) : r.vastXml = e.adm;
          let p = null;
          ...
          return e.ext && e.ext.vasturl || e.mtype == J ? (r.width = i.video.w, r.height = i.video.h, r.mediaType = s.G_, r.mediaTypes = i.mediaTypes, r.ttl = a ? e.exp : 3600) : p && p.native ? (r.native = {
            ortb: p.native
          }, r.width = e.w ? e.w : 1, r.height = e.h ? e.h : 1, r.mediaType = s.s6, r.ttl = a ? e.exp : 3600) : (r.ad = e.adm, r.width = e.w, r.height = e.h, r.mediaType = s.D4, r.ttl = a ? e.exp : 300), r.meta = {}, r.meta.networkId = (0, n.A)(e, "ext.dspid"), r.meta.brandId = (0, n.A)(e, "ext.advbrandid"), r.meta.brandName = (0, n.A)(e, "ext.advbrand"), e.adomain && e.adomain.length > 0 && (r.meta.advertiserDomains = e.adomain), e.ext?.dsa && (r.meta.dsa = e.ext.dsa), e.ext?.ibv && (r.ext = r.ext || {}, r.ext.ibv = e.ext.ibv), r
        }
        ...
        function G(e, t, i, r) {
          ...
          if (y.length > 0) {
            const s = y.reduce(((e, t) => (e[t.adunitCode] || (e[t.adunitCode] = []), e[t.adunitCode].push(t), e)), {});
            for (const d in s) {
              const p = s[d],
                {
                  id: l,
              ...
              for (let e = 0; e < y.banner.format.length; e++) null != y.banner.format[e].ext && (null != y.banner.format[e].ext.sid && delete y.banner.format[e].ext.sid, null != y.banner.format[e].ext.externalID && delete y.banner.format[e].ext.externalID), "bidfloor" in p[e] && (y.banner.format[e].ext.bidfloor = p[e].bidfloor), "{}" === JSON.stringify(y.banner.format[e].ext) && delete y.banner.format[e].ext;
              const v = e[t[r]].pos;
              (0, o.isInteger)(v) && (y.banner.pos = v), (f || m || g || b || x || u || h) && (y.ext = {}, y.ext.dfp_ad_unit_code = f, y.ext.gpid = m, y.ext.tid = g, y.ext.sid = b, y.ext.externalID = u, 1 == x && (y.ext.ae = 1, y.ext.paapi = h)), "bidfloor" in p[0] && (y.bidfloor = p[0].bidfloor), "bidfloorcur" in p[0] && (y.bidfloorcur = p[0].bidfloorcur);
          ...
          isBidRequestValid: function(e) {
            ...
            if (a && t) {
              ...
              if ((0, n.A)(e, "mediaTypes.video.context") === u.H6 && re(e) && i) {
                ...
                if (!(e[0] >= h[0] && e[1] >= h[1])) return (0, o.logError)(`IX Bid Adapter: ${e} is an invalid size for IX outstream renderer`), !1
              }
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [61665], {
      62349: (t, e, a) => {
          ...
          d = {
            ...
            buildRequests: (0, o.lE)((function() {
              ...
              const {
                ...
                if (!u.hasLocalStorage()) return;
                let t = (0, o.pT)(u.getDataFromLocalStorage("_iiq_fdata"));
                t || (t = d.createFirstPartyData(), u.setDataInLocalStorage("_iiq_fdata", JSON.stringify(t)));
                return t
              }();
              return {
                auctionId: a,
        ...
        }(0, n.a$)(d), (0, r.E)("kueezRtbBidAdapter")
      }
    },
    t => {
      t.O(0, [44982, 85946, 60802, 37769, 12139, 51085], (() => {
        return e = 62349, t(t.s = e);
        var e
      }));
      t.O()
    }
    ...
    [52787], {
      73853: (a, e, t) => {
        var i = t(7873),
          ...
          m = t(57377);
        const n = {
          ...(0, t(37668).B2)("https://hb.minutemedia-prebid.com/", {
          ...
          isBidRequestValid: function(a) {
            return a.params ? !!a.params.org || ((0, r.logWarn)("org is a mandatory param for MinuteMedia adapter"), !1) : ((0, r.logWarn)("no params have been set to MinuteMedia adapter"), !1)
          }
        };
        (0, m.a$)(n), (0, i.E)("minutemediaBidAdapter")
      }
    },
    a => {
      a.O(0, [12183, 60802, 37769, 12139, 51085], (() => {
        return e = 73853, a(a.s = e);
        var e
      }));
      a.O()
    }
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [32149], {
      61725: (e, t, n) => {
        ...
        function b(e, t) {
          if (e === r.D4) return U(t).length > 0;
          if (e === r.G_ && v(t)) {
            const e = t.mediaTypes.video.context;
            if ("outstream" === e || "instream" === e) return O(t).length > 0
          } else if (e === r.s6) {
            if ("object" != typeof t.mediaTypes.native || null === t.mediaTypes.native) return !1;
            if (!S(t)) {
              if (void 0 === t.nativeParams) return !1;
              const e = (0, f.rn)(t.nativeParams);
            ...
            return i && Array.isArray(i) && i.length > 0 && i.every((e => I(e))) && (e = !0), r && Array.isArray(r) && r.length > 0 ? r.every((e => T(e))) && (n = !0) : r || (n = !0), e && n
          }
          return !1
        }
        const T = function(e) {
          ...
          I = function(e) {
            if (!e.hasOwnProperty("id") || !Number.isInteger(e.id)) return !1;
        ...
        function C(e) {
          const t = (0, c.getWinDimensions)(),
            n = function() {
              let e = window,
                t = window.parent;
              try {
                for (; e !== e.parent;) t = e.parent, t.location.href, e = e.parent
              } catch (e) {}
              return e
            }();
          return {
            location: (0, l.A)(e, "refererInfo.page", null),
            referrer: (0, l.A)(e, "refererInfo.ref", null),
            stack: (0, l.A)(e, "refererInfo.stack", []),
            numIframes: (0, l.A)(e, "refererInfo.numIframes", 0),
            wWidth: (0, c.getWinDimensions)().innerWidth,
            wHeight: (0, c.getWinDimensions)().innerHeight,
            oWidth: t.outerWidth,
        ...
        function w(e) {
          const t = e.filter((e => v(e))).map((e => {
              const t = {};
              return z.call(t, e), t.context = e.mediaTypes.video.context, t.playerSize = O(e), t.mediaTypeInfo = (0, c.deepClone)(e.mediaTypes.video), t.type = r.G_, t.priceFloors = D(e, r.G_, t.playerSize), t
            })),
            n = e.filter((e => b(r.D4, e))).map((e => {
              const t = {};
              return z.call(t, e), t.sizes = U(e), t.type = r.D4, t.mediaTypeInfo = (0, c.deepClone)(e.mediaTypes.banner), t.priceFloors = D(e, r.D4, t.sizes), t
            })),
            i = e.filter((e => b(r.s6, e))).map((e => {
              const t = {};
              if (z.call(t, e), t.sizes = U(e), t.type = r.s6 + y, t.mediaTypeInfo = (0, c.deepClone)(e.mediaTypes.native), !S(e)) {
                const n = (0, f.rn)(e.nativeParams);
                t.mediaTypeInfo = {}, t.mediaTypeInfo.adTemplate = e.nativeParams.adTemplate, t.mediaTypeInfo.ortb = n
              }
              return t.priceFloors = D(e, r.s6, t.sizes), t
            }));
        ...
        function z(e) {
          const t = e.params;
          this.adUnitCode = e.adUnitCode, this.bidId = e.bidId, this.bidderRequestId = e.bidderRequestId, this.auctionId = (0, l.A)(e, "ortb2.source.tid"), this.transactionId = (0, l.A)(e, "ortb2Imp.ext.tid"), this.gpid = (0, l.A)(e, "ortb2Imp.ext.gpid") || (0, l.A)(e, "ortb2Imp.ext.data.pbadslot"), this.pubId = t.pubId, this.ext = t.ext, this.ortb2Imp = (0, l.A)(e, "ortb2Imp"), t.pubClick && (this.click = t.pubClick), t.dealId && (this.dealId = t.dealId);
          const n = function(e) {
            ...
            try {
              ...
              for (; null != a;) {
                ...
                o.top += e + s.pageYOffset, o.left += t + s.pageXOffset, s = s.parent, a = s.frameElement
              }
              return o
            } catch (e) {
              return null
        ...
        function U(e) {
          if (void 0 !== e.mediaTypes && void 0 !== e.mediaTypes.banner && void 0 !== e.mediaTypes.banner.sizes && Array.isArray(e.mediaTypes.banner.sizes) && e.mediaTypes.banner.sizes.length > 0) return H(e.mediaTypes.banner.sizes);
        ...
        function D(e, t, n) {
          if ("function" != typeof e.getFloor) return [];
          const i = n => {
            const i = e.getFloor({
              currency: "EUR",
              mediaType: t || "*",
        ...
        const k = {
          ...
          buildRequests: function(e, t) {
            ...
            }), t && t.uspConsent && (n.usPrivacy = t.uspConsent), t && t.ortb2 && (n.ortb2 = t.ortb2), e && 0 !== e.length && e[0].userIdAsEids && (n.userId = e[0].userIdAsEids), e && 0 !== e.length && e[0].schain && function(e) {
              let t = !1;
              const n = ["asi", "sid", "hp"];
              if (!e || !e.nodes) return t;
              t = e.nodes.reduce(((e, t) => e ? n.every((e => t.hasOwnProperty(e))) : e), !0), t || (0, c.logError)("OneTag: required schain params missing");
              return t
            ...
            return n.networkConnectionType = i && i.type ? i.type : null, n.networkEffectiveConnectionType = i && i.effectiveType ? i.effectiveType : null, n.fledgeEnabled = Boolean(t?.paapi?.enabled), {
              method: "POST",
          ...
          interpretResponse: function(e, t) {
            const n = e.body,
              i = [],
              d = JSON.parse(t.data);
            if (!n || n.nobid && !0 === n.nobid) return i;
            if (!(n.fledgeAuctionConfigs || n.bids && Array.isArray(n.bids) && 0 !== n.bids.length)) return i;
            if (Array.isArray(n.bids) && n.bids.forEach((e => {
                ...
                if (e.dsa && (t.meta.dsa = e.dsa), e.mediaType === r.D4) t.ad = e.ad;
                else if (e.mediaType === r.G_) {
                  const {
                    context: n,
                    adUnitCode: i
                  } = (0, a.I6)(d.bids, (t => t.bidId === e.requestId && t.type === r.G_));
                  n === s.mn ? (t.vastUrl = e.vastUrl, t.videoCacheKey = e.videoCacheKey) : n === s.H6 && (t.vastXml = e.ad, t.vastUrl = e.vastUrl, e.rendererUrl && (t.renderer = function(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                ...
                } else e.mediaType !== r.s6 && e.mediaType !== r.s6 + y || (t.native = e.native);
                i.push(t)
          ...
          getUserSyncs: function(e, t, n, i, r) {
            let s = [],
              o = "";
            return n && ("boolean" == typeof n.gdprApplies && (o += "&gdpr=" + (n.gdprApplies ? 1 : 0)), "string" == typeof n.consentString && (o += "&gdpr_consent=" + n.consentString)), r && "string" == typeof r.gppString && (o += "&gpp_consent=" + r.gppString), i && "string" == typeof i && (o += "&us_privacy=" + i), e.iframeEnabled && s.push({
              type: "iframe",
        ...
        (0, p.a$)(k), (0, i.E)("onetagBidAdapter")
      }
    },
    e => {
      e.O(0, [32316, 60802, 37769, 12139, 51085], (() => {
        return t = 61725, e(e.s = t);
        var t
      }));
      e.O()
    }
    ...
    [63879], {
      57257: (e, t, a) => {
          ...
          l = {
            ...
            getUserSyncs: function(e, t, a, n) {
              if (e.iframeEnabled || e.pixelEnabled) {
                ...
                if (a && (s.push("gdpr=" + (a.gdprApplies ? 1 : 0)), s.push("gdpr_consent=" + encodeURIComponent(a.consentString || ""))), n && s.push("us_privacy=" + encodeURIComponent(n)), t.length > 0 && t[0].body && t[0].body.ext) {
        ...
        const c = (0, m.A)({
          ...
          imp(e, t, a) {
            const n = e(t, a);
            return (0, i.mergeDeep)(n, {
              tagid: t.params.unit,
              ext: {
                divid: t.adUnitCode
              }
            }), t.params.customParams && o.J(n, "ext.customParams", t.params.customParams), t.params.customFloor && !n.bidfloor && (n.bidfloor = t.params.customFloor), n
          },
          request(e, t, a, n) {
            const r = e(t, a, n);
            (0, i.mergeDeep)(r, {
            ...
            return s.params.coppa && o.J(r, "regs.coppa", 1), s.params.doNotTrack && o.J(r, "device.dnt", 1), s.params.platform && o.J(r, "ext.platform", s.params.platform), s.params.delDomain && o.J(r, "ext.delDomain", s.params.delDomain), s.params.response_template_name && o.J(r, "ext.response_template_name", s.params.response_template_name), s.params.test && (r.test = 1), r
          },
          bidResponse(e, t, a) {
            const n = e(t, a);
            return t.ext && (n.meta.networkId = t.ext.dsp_id, n.meta.advertiserId = t.ext.buyer_id, n.meta.brandId = t.ext.brand_id), n
          },
          response(e, t, a, n) {
            const {
              ortbRequest: r
            } = n;
            r.ext && (r.ext.delDomain && o.J(a, "ext.delDomain", r.ext.delDomain), r.ext.platform && o.J(a, "ext.platform", r.ext.platform));
            const s = e(t, a, n);
            ...
            return d ? (d = Object.entries(d).map((e => {
              ...
              return {
                bidId: t,
                config: (0, i.mergeDeep)(Object.assign({}, a), {
                  auctionSignals: {
              ...
              video(e, t, a, n) {
                {
                  ...
                  r && (r = Object.assign({}, r, a.params.video), a = {
                    ...a,
                    mediaTypes: {
                      [d.G_]: r
                    }
      ...
      63990: (e, t, r) => {
        ...
        const R = (0, u.A)({
          ...
          request(e, t, r, i) {
            ...
            N(n), M(n, i?.bidRequests), B(n);
            return (r?.bidderCode ? c.u.get(r.bidderCode, "allowAlternateBidderCodes") : void 0) && q(n, r), n
          },
          bidResponse(e, t, r) {
            const i = e(t, r);
            i.meta && (i.meta.mediaType = i.mediaType), z(i, t, r);
            const {
              mediaType: o,
              playerWidth: a,
              playerHeight: s
            ...
            if (o === d.G_) {
              ...
              "outstream" === e && l.outstreamAU && p && (i.rendererCode = l.outstreamAU, i.renderer = L.newRenderer(i.rendererCode, p)), D(i, e, t)
            }
            if (o === d.s6 && t.adm) {
              try {
                ...
                return void(0, n.logWarn)(`${g}Error: Cannot parse native response for ad response: ${t.adm}`)
              }
        ...
        const j = e => {
            const t = {};
            if (e.aspect_ratios && (0, n.isArray)(e.aspect_ratios) && e.aspect_ratios.length) {
              const {
                min_width: r,
                min_height: i
              } = e.aspect_ratios[0];
              (0, n.isInteger)(r) && (0, n.isInteger)(i) && (t.wmin = r, t.hmin = i), t.ext = {
            ...
            return t.w = e.w || e.width, t.h = e.h || e.height, e.sizes && 2 === e.sizes.length && (0, n.isInteger)(e.sizes[0]) && (0, n.isInteger)(e.sizes[1]) && (t.w = e.sizes[0], t.h = e.sizes[1], delete t.wmin, delete t.hmin), e.ext && (t.ext = e.ext), e.mimes && (t.mimes = e.mimes), t
          },
          O = e => {
            e.displaymanager ||= "Prebid.js", e.displaymanagerver ||= "9.44.1";
        ...
        const A = (e, t) => {
            ...
            "function" != typeof t.getFloor || l.$W.getConfig("pubmatic.disableFloors") || [d.D4, d.G_, d.s6].forEach((i => {
              ...
              (("banner" === i ? e[i]?.format?.map((e => {
                ...
                if ((0, n.logInfo)(g, "floor from floor module returned for mediatype:", i, " and size:", a, " is: currency", s.currency, "floor", s.floor), (0, n.isPlainObject)(s) && s?.currency === e.bidfloorcur && !isNaN(parseInt(s.floor))) {
                  const t = parseFloat(s.floor);
                  o && i !== d.D4 && ((0, n.logInfo)(g, "floor from floor module returned for mediatype:", i, "is : ", t, "with currency :", e.bidfloorcur), e[i].ext = {
                    bidfloor: t,
                    bidfloorcur: e.bidfloorcur
                  }), (0, n.logInfo)(g, "floor from floor module:", t, "previous floor value", r, "Min:", Math.min(t, r)), r = -1 === r ? t : Math.min(t, r), (0, n.logInfo)(g, "new floor value:", r)
                }
              })), o && i === d.D4 && (e[i].ext = {
                bidfloor: r,
                bidfloorcur: e.bidfloorcur
              })
            })), e.bidfloor && ((0, n.logInfo)(g, "Comparing floors:", "from floor module:", r, "impObj.bidfloor:", e.bidfloor, "Max:", Math.max(r, e.bidfloor)), r = Math.max(r, e.bidfloor)), e.bidfloor = r > 0 ? r : f, (0, n.logInfo)(g, "Updated imp.bidfloor:", e.bidfloor), o && function(e, t) {
              t.forEach((t => {
          ...
          S = (e, t) => {
            ...
            const n = e.format[0];
            2 !== i.length || 0 == parseInt(i[0]) && 0 == parseInt(i[1]) ? (e.w = n.w, e.h = n.h) : (e.w = parseInt(i[0]), e.h = parseInt(i[1])), e.format = e.format.filter((t => !(t.w === e.w && t.h === e.h))), e.pos ??= 0
          },
          E = (e, t, r) => {
          ...
          U = (e, t) => {
            if (t?.ortb || (e.native.request = JSON.stringify((e => {
                ...
                for (let r in e) {
                  if (m._B.includes(r)) continue;
                  if (!m.x5.hasOwnProperty(r) && !h.includes(r)) {
                    (0, n.logWarn)(`${g}: Unrecognized asset: ${r}. Ignored.`);
                    continue
                  }
                  const i = e[r],
                    o = i.required && (0, n.isBoolean)(i.required) ? 1 : 0,
                    a = {
                      id: t.assets.length,
                      required: o
                    };
                  ...
                  } : "ext" === r && (a.ext = i, delete a.required), t.assets.push(a)
                }
                return t
              })(t))), t?.ortb) {
              ...
              r?.some((e => e.title || e.img || e.data || e.video)) ? e.native.request = JSON.stringify({
                ver: "1.2",
                ...t
              }) : ((0, n.logWarn)(`${g}: Native assets object is empty or contains invalid objects`), delete e.native)
            }
          },
          T = (e, t, r, i) => {
            (0, o.A)(t, "plcmt") || (0, n.logWarn)("Video.plcmt param missing for " + r), t && (e.w || e.h) || (delete i.video, (0, n.logWarn)(`${g}Error: Missing ${t?"video size params (playersize or w&h)":"video config params"} for adunit: ${r} with mediaType set as video. Ignoring video impression in the adunit.`))
          },
          k = (e, t) => {
            const r = t?.targeting;
          ...
          P = (e, t) => {
            if ((0, n.isStr)(t) && t.length > 0) {
              const r = t.split("|").filter((e => e.trim().length > 0));
              t = r.map((e => e.trim())).join("|"), e.ext.key_val = t
            } else(0, n.logWarn)(g + "Ignoring param : dctr with value : " + t + ", expects string-value, found empty or non-string value")
          },
          W = (e, t) => {
            (0, n.isArray)(t) ? t.forEach((t => {
              "string" == typeof t && t.length > 3 ? (e.pmp || (e.pmp = {
                private_auction: 0,
                deals: []
              }), e.pmp.deals.push({
                id: t
              })) : (0, n.logWarn)(`${g}Error: deal-id present in array bid.params.deals should be a string with more than 3 characters length, deal-id ignored: ${t}`)
            })): (0, n.logWarn)(`${g}Error: bid.params.deals should be an array of strings.`)
          },
          q = (e, t) => {
            const r = ["all"];
            let i = c.u.get(t.bidderCode, "allowedAlternateBidderCodes");
            const o = (0, n.isArray)(i) ? i.map((e => e.trim().toLowerCase())).filter(n.uniques) : r;
            e.ext.marketplace = {
              allowedbidders: o.includes("*") || o.includes("all") ? r : [...new Set(["pubmatic", ...o.filter((e => e && e.trim()))])]
            }
          },
          N = e => {
            (0, a.J)(e, "at", 1), (0, a.J)(e, "cur", ["USD"]), e.test = window.location.href.includes("pubmaticTest=true") ? 1 : void 0, e.source && !Object.keys(e.source).length && delete e.source, e.app?.publisher && (e.app.publisher.id = _)
          },
          M = (e, t) => {
            const {
              gender: r,
            ...
            t.length && l?.length && !e.user.ext?.eids && (e.user.ext = e.user.ext || {}, e.user.ext.eids = l), e.site?.publisher && (e.site.ref = e.site.ref || a, e.site.publisher.id = n?.trim()), e.site?.page && s && (e.site.page = s.trim()), e.device.geo && !e.user.geo ? e.user.geo = e.device.geo : e.user.geo && !e.device.geo && (e.device.geo = e.user.geo)
          },
          z = (e, t, r) => {
            const {
              ortbRequest: i,
            ...
            if (e.referrer = i.site?.ref || "", e.sspID = e.partnerImpId = t.id || "", e.ad = t.adm, e.pm_dspid = t.ext?.dspid ? t.ext.dspid : null, e.pm_seat = n.seat, e.creativeId || (e.creativeId = t.id), 360 == e.ttl && (e.ttl = w[e.mediaType]), t.dealid && (e.dealChannel = t.ext?.deal_channel ? v[t.ext.deal_channel] || null : "PMP"), n.ext?.buyid && (e.adserverTargeting = {
                hb_buyid_pubmatic: n.ext.buyid
              }), t.ext?.marketplace && (e.bidderCode = t.ext.marketplace), t.ext) {
              const {
                dspid: r,
                dchain: i,
                dsa: n,
              ...
              r && (e.meta.networkId = e.meta.demandSource = r), i && (e.meta.dchain = i), n && Object.keys(n).length && (e.meta.dsa = n), o && (e.ext = e.ext || {}, e.ext.ibv = o, e.meta.mediaType = d.G_)
            }
            const o = n.seat || t.ext?.advid;
            o && (e.meta.advertiserId = e.meta.agencyId = e.meta.buyerId = o), V(t.adomain) && (e.meta.clickUrl = e.meta.brandId = t.adomain[0])
          },
          B = e => {
            const {
              profId: t,
          ...
          F = e => [...new Set(e.filter((e => {
            ...
            (0, n.logWarn)(g + "acat: Each category should be a string, ignoring category: " + e)
          })).map((e => e.trim())))],
          G = e => {
            const t = (e = e.map((e => "string" == typeof e ? e.trim() : e))).filter((e => "string" != typeof e || e.length < 3));
            return (0, n.logWarn)(g + "bcat: Each category must be a string with a length greater than 3, ignoring " + t), [...new Set(e.filter((e => "string" == typeof e && e.length >= 3)))]
          },
          J = () => {
          ...
          L = {
            bootstrapPlayer: function(e) {
              ...
              if (!t.vastXml && !t.vastUrl) return void(0, n.logWarn)(`${g}: No vastXml or vastUrl on bid, bailing...`);
              ...
              o ? o.bootstrap(t, i) : (0, n.logWarn)(`${g}: Couldn't find a renderer with ${r}`)
            },
            newRenderer: function(e, t) {
              ...
              try {
                ...
                (0, n.logWarn)(`${g}: Error tying to setRender on renderer`, e)
              }
              return i
            },
        ...
        function X(e, t) {
          if (!(0, n.isStr)(t)) return t && (0, n.logWarn)(g + "Ignoring param key: " + e + ", expects string-value, found " + typeof t), f;
          const r = {
        ...
        function V(e) {
          return !0 === (0, n.isArray)(e) && e.length > 0
        }
        const H = {
          code: "pubmatic",
          gvlid: 76,
          ...
          isBidRequestValid: e => {
            ...
            const {
              publisherId: t
            } = e.params, r = e.mediaTypes || {}, i = r[d.G_] || {};
            if (!(0, n.isStr)(t)) return (0, n.logWarn)(g + "Error: publisherId is mandatory and cannot be numeric (wrap it in quotes in your config). Call to OpenBid will not be sent for ad unit: " + JSON.stringify(e)), !1;
            if (r.hasOwnProperty(d.G_)) {
              const t = (0, o.A)(e, "mediaTypes.video.mimes"),
                a = (0, o.A)(e, "params.video.mimes");
              if (!V(t) && !V(a)) return (0, n.logWarn)(g + "Error: For video ads, bid.mediaTypes.video.mimes OR bid.params.video.mimes should be present and must be a non-empty array. Call to OpenBid will not be sent for ad unit:" + JSON.stringify(e)), !1;
              if (!i.context) return (0, n.logError)(`${g}: No context specified in bid. Rejecting bid: `, e), !1;
              if ("outstream" === i.context && !(0, n.isStr)(e.params.outstreamAU) && !e.renderer && !i.renderer) return r.hasOwnProperty(d.D4) || r.hasOwnProperty(d.s6) ? (delete r[d.G_], (0, n.logWarn)(`${g}: for "outstream" bids either outstreamAU parameter must be provided or ad unit supplied renderer is required. Rejecting mediatype Video of bid: `, e), !0) : ((0, n.logError)(`${g}: for "outstream" bids either outstreamAU parameter must be provided or ad unit supplied renderer is required. Rejecting bid: `, e), !1)
            }
            return !0
          },
          buildRequests: (e, t) => {
            ...
            var d;
            _ = o?.trim() || (d = t?.bids, Array.isArray(d) && d.length > 0 && d.find((e => e.params?.publisherId?.trim()))?.params.publisherId || null)?.trim();
            const l = (0, n.generateUUID)();
            let p;
            C = [], $ = [], I = {
              ...
              e.params.wiid = e.params.wiid || t.auctionId || l, p = (0, n.deepClone)(e), ((e, t) => {
                Object.keys(y).forEach((r => {
                  const i = e[r];
                  i && ((0, n.isStr)(i) ? t[r] = i : (0, n.logWarn)(`${g}Ignoring param: ${r} with value: ${y[r]}, expects string value, found ${typeof i}`))
                }))
              })(p.params, I), I.transactionId = p.ortb2Imp?.ext?.tid;
              const {
                bcat: r,
                acat: i
              } = p.params;
              r && (C = C.concat(r)), i && ($ = $.concat(i))
            }));
            const c = R.toORTB({
              validBidRequests: e,
              bidderRequest: t
          ...
          getUserSyncs: (e, t, r, i, n) => {
            let o = _;
            r && (o += `&gdpr=${r.gdprApplies?1:0}&gdpr_consent=${encodeURIComponent(r.consentString||"")}`), i && (o += `&us_privacy=${encodeURIComponent(i)}`), n?.gppString && n?.applicableSections?.length && (o += `&gpp=${encodeURIComponent(n.gppString)}&gpp_sid=${encodeURIComponent(n.applicableSections.join(","))}`), !0 === l.$W.getConfig("coppa") && (o += "&coppa=1");
          ...
          onBidWon: e => {
            ! function(e) {
              ...
              const {
                ...
                originalCpm: o,
                meta: a
              } = e, s = t !== r && (0, n.isFn)(e.getCpmInNewCurrency) ? e.getCpmInNewCurrency(t) : i, d = e.mediaType, l = a?.mediaType;
              x = x || {
                currency: r,
                originalCurrency: t,
                adjustment: []
              ...
              const p = {
                ...
                c = x?.adjustment?.findIndex((e => e?.mediaType === d && e?.metaMediaType === l)); - 1 !== c ? x.adjustment.splice(c, 1, p) : x.adjustment.push(p)
            }(e)
          }
        };
        (0, s.a$)(H), (0, i.E)("pubmaticBidAdapter")
      }
    },
    e => {
      e.O(0, [60802, 58498, 37769, 12139, 51085], (() => {
        return t = 63990, e(e.s = t);
        var t
      }));
      e.O()
    }
    ...
    [53206], {
      26848: (a, r, s) => {
        ...
        const p = {
          ...
          gvlid: t.H,
          isBidRequestValid: function(a) {
            return a.params ? !!a.params.org || ((0, n.logWarn)("org is a mandatory param for Rise adapter"), !1) : ((0, n.logWarn)("no params have been set to Rise adapter"), !1)
          }
        };
        (0, i.a$)(p), (0, e.E)("riseBidAdapter")
      }
    },
    a => {
      a.O(0, [12183, 60802, 37769, 12139, 51085], (() => {
        return r = 26848, a(a.s = r);
        var r
      }));
      a.O()
    }
                ...
                function(e, t, r) {
                  ...
                  if (t === d.D4) {
                    ...
                    e && !1 !== x.chEnabled && (0, p.pick)(e, ["architecture", e => r.m_ch_arch = e, "bitness", e => r.m_ch_bitness = e, "browsers", e => {
                      ...
                      const [t, i] = e.reduce(((e, t) => (e[0].push(`"${t?.brand}"|v="${t?.version?.[0]}"`), t.version.length > 1 && e[1].push(`"${t?.brand}"|v="${t?.version?.join?.(".")}"`), e)), [
                        [],
                        []
                      ]);
    ...
    [45496], {
      25862: (e, o, t) => {
        ...
        const h = {
          ...
          gvlid: a.B1,
          decode(e, o) {
            if (v()) return void(0, r.logInfo)("PubCommonId decode: Has opted-out");
          ...
          extendId: function() {
            let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
              o = arguments.length > 1 ? arguments[1] : void 0,
              t = arguments.length > 2 ? arguments[2] : void 0;
            if (v()) return (0, r.logInfo)("PubCommonId: Has opted-out"), {
              id: void 0
            };
            if (o?.coppa) return void(0, r.logInfo)("PubCommonId: IDs not provided for coppa requests, exiting PubCommonId");
            const {
      ...
      88518: (e, t, a) => {
        ...
        const m = {
          ...
          fillPayloadForVideoBidRequest: function(e, t, a) {
            ...
            e.mediaType = o.G_, e.isVideo = "instream" === t.context, e.videoData = {};
            for (const [a, r] of Object.entries(i)) e.videoData = {
              ...e.videoData,
            ...
            e.videoData = {
              ...
              ...(0, s.isArrayOfNums)(t.api) && t.api.length ? {
                iabframeworks: t.api.toString()
              } : {},
              ...(0, s.isArrayOfNums)(t.playbackmethod) && t.playbackmethod.length ? {
                vpmt: t.playbackmethod
              } : {}
            }
          },
          getValuableProperty: function(e, t) {
            return "string" == typeof e && (0, s.isInteger)(t) && t ? {
              [e]: t
            } : {}
          },
          ...
          getStartDelayForVideoBidRequest: function(e, t) {
            if (t?.startDelay) return t.startDelay;
            if (e?.startdelay) {
              if (e.startdelay > 0 || -1 == e.startdelay) return 2;
          ...
          buildRequests: function(e, t) {
            const a = (0, l.b)(t),
              r = (0, i.A)(t, "ortb2.user.data", d.$W.getAnyConfig("ortb2.user.data")),
              p = (0, i.A)(t, "ortb2.site.content.data", d.$W.getAnyConfig("ortb2.site.content.data"));
            return e.reduce(((e, l) => {
              let u = {
              ...
              const c = (0, i.A)(l, "ortb2Imp.ext.gpid") || (0, i.A)(l, "ortb2Imp.ext.data.pbadslot");
              c && (u.gpid = c);
              const g = (0, i.A)(l, "ortb2.regs.ext.dsa");
              g && (u.dsa = g), t && (t.gdprConsent && (u.addtl_consent = t.gdprConsent.addtlConsent, u.gdpr_consent = t.gdprConsent.consentString, u.gdpr = t.gdprConsent.gdprApplies), t.gppConsent && (u.gpp = t.gppConsent.gppString, u.gpp_sid = t.gppConsent.applicableSections), t.uspConsent && (u.us_privacy = t.uspConsent)), l && l.userIdAsEids && (u.eids = l.userIdAsEids), t && t.uspConsent && (u.us_privacy = t.uspConsent);
              const y = (0, i.A)(l, "mediaTypes.banner"),
                b = (0, i.A)(l, "mediaTypes.video"),
                f = b && ("instream" === b.context || "outstream" === b.context);
              if (y || f) {
                let t;
                if (y) {
                  if (t = o.D4, u.sizes = m.adaptBannerSizes(y.sizes), f) {
                    let t = (0, s.deepClone)(u);
                    m.fillPayloadForVideoBidRequest(t, b, l.params.video), t.bidfloor = l.params.bidfloor || (0, n.M)(l, a, o.G_), e.push(m.createServerRequest(t, l.params.domain))
                  }
                } else t = o.G_, m.fillPayloadForVideoBidRequest(u, b, l.params.video);
                u.bidfloor = l.params.bidfloor || (0, n.M)(l, a, t), e.push(m.createServerRequest(u, l.params.domain))
              } else e.push({});
              return e
            }), [])
          },
            ...
            try {
              if (r && !r.isNoAd && (r.ad || r.adUrl)) {
                ...
                let i = {
                  ...
                  meta: {
                    ...(0, s.isArray)(r.adomain) && !(0, s.isEmpty)(r.adomain) ? {
                ...
                e.mediaType === o.G_ ? (i.mediaType = o.G_, i.vastUrl = r.adUrl, i.vastXml = r.ad, i.content = r.ad) : (i.adUrl = r.adUrl, i.ad = r.ad), a.push(i)
              }
            } catch (e) {
              (0, s.logError)("Error while parsing smart server response", e)
            }
            return a
          },
          getUserSyncs: function(e, t) {
        ...
        (0, p.a$)(m), (0, r.E)("smartadserverBidAdapter")
      }
    },
    e => {
      e.O(0, [19147, 90467, 60802, 37769, 12139, 51085], (() => {
        return t = 88518, e(e.s = t);
        var t
      }));
      e.O()
    }
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [68723], {
      32605: (e, r, t) => {
        ...
        const p = {
            ...t(90011).Z,
            placement: e => (0, s.isInteger)(e) && e >= 1 && e <= 5,
            plcmt: e => (0, s.isInteger)(e) && e >= 1 && e <= 4,
            delivery: e => Array.isArray(e) && e.every((e => e >= 1 && e <= 3)),
            pos: e => (0, s.isInteger)(e) && e >= 1 && e <= 7
          },
          c = {
            mimes: p.mimes,
          ...
          l = {
            ...
            buildRequests: function(e, r) {
              try {
                let t, i, o, d, c = [];
                (0, s._each)(e, (function(e) {
                  !o && e.userIdAsEids && (o = e.userIdAsEids, o.forEach((function(e) {
                    e.uids && e.uids[0] && "criteo.com" === e.source && (d = e.uids[0].id)
                  }))), e.schain && (i = i || e.schain), t = t || (0, s.getBidIdParameter)("iv", e.params);
                  const a = {
                    adunitcode: e.adUnitCode,
                    id: e.bidId,
                    tagid: String((0, s.getBidIdParameter)("tagid", e.params)),
                    bidfloor: u(e)
                  };
                  if ((0, n.A)(e, "mediaTypes.banner")) {
                    let r = (0, n.A)(e, "mediaTypes.banner.sizes") || e.sizes;
                    r = (0, s.isArray)(r) && (0, s.isArray)(r[0]) ? r : [r], r = r.filter((e => (0, s.isArray)(e)));
                    const t = r.map((e => ({
                      w: parseInt(e[0], 10),
                      h: parseInt(e[1], 10)
                    })));
                  ...
                  }(0, n.A)(e, "mediaTypes.video") && (a.video = function(e) {
                    const r = {},
                      t = (0, n.A)(e, "sizes"),
                      i = (0, n.A)(e, "mediaTypes.video", {}),
                      a = (0, n.A)(e, "params.video", {}),
                      o = {};
                    if (t) {
                    ...
                    return Object.keys(p).forEach((e => {
                      d.hasOwnProperty(e) && (p[e](d[e]) ? r[e] = d[e] : (0, s.logWarn)(`The OpenRTB video param ${e} has been skipped due to misformating. Please refer to OpenRTB 2.5 spec.`))
                    })), r
                  }(e)), a.ext = (0, s.getBidIdParameter)("ext", e.ortb2Imp) || void 0;
                  const l = (0, s.getBidIdParameter)("segments", e.params);
                  l && (a.ext = a.ext || {}, a.ext.deals = l.split(",").map((e => e.trim())));
                  const m = e?.ortb2Imp?.ext?.ae;
                  r.paapi?.enabled && (0, s.isInteger)(m) ? (a.ext = a.ext || {}, a.ext.ae = m) : a.ext?.ae && delete a.ext.ae, c.push(a)
                }));
                const l = r.ortb2 || {},
                  m = l.site || {};
                m.page = r.refererInfo.page, m.domain = r.refererInfo.domain;
                const g = (0, n.A)(r, "timeout"),
                  y = {
                    id: (0, s.getUniqueIdentifierStr)(),
                    imp: c,
                    site: m,
                    user: l.user || {},
                    tmax: g
                ...
                const b = (0, n.A)(r, "ortb2.source.tid");
                b && (0, a.J)(y, "source.tid", b);
                (0, n.A)(r, "ortb2.regs.coppa") && (0, a.J)(y, "regs.coppa", 1);
                const f = (0, n.A)(r, "ortb2.bcat");
                f && (0, a.J)(y, "bcat", f), r.gdprConsent && ((0, a.J)(y, "regs.ext.gdpr", +r.gdprConsent.gdprApplies), (0, a.J)(y, "user.ext.consent", r.gdprConsent.consentString)), r.uspConsent && (0, a.J)(y, "regs.ext.us_privacy", r.uspConsent), r.gppConsent && ((0, a.J)(y, "regs.gpp", r.gppConsent.gppString), (0, a.J)(y, "regs.gpp_sid", r.gppConsent.applicableSections)), r?.ortb2?.device && (y.device = y.device || {}, (0, s.mergeDeep)(y.device, r.ortb2.device)), o && ((0, a.J)(y, "user.ext.eids", o), d && (0, a.J)(y, "user.ext.prebid_criteoid", d));
                ...
                (0, s.logError)("Could not build bidrequest, error deatils:", e)
              }
            },
            interpretResponse: function(e) {
              let {
              ...
              try {
                let e = t.filter((e => e)).map((e => e.bid.map((e => {
                    ...
                    return e.nurl ? r.ad = decodeURIComponent(`${e.adm}<img src="${e.nurl}">`) : r.vastXml = decodeURIComponent(e.adm), r
                  })))).flat(),
                  r = null;
                if ((0, s.isArray)(i?.igbid)) {
                  const e = i.seller,
                    t = i.decisionLogicUrl,
                    n = i.sellerTimeout;
                  i.igbid.filter((e => {
                    return r = e, !(0, s.isEmptyStr)(r.impid) && (0, s.isArray)(r.igbuyer) && r.igbuyer.length;
                    var r
                  })).forEach((i => {
                    const a = {};
                    i.igbuyer.filter((e => {
                      return r = e, !(0, s.isEmptyStr)(r.igdomain);
                      var r
                    })).forEach((e => {
                      a[e.igdomain] = e.buyerdata
                    }));
                    const o = [...Object.keys(a)];
                    o.length && (r = r || {}, r[i.impid] = {
                      seller: e,
                      decisionLogicUrl: t,
                      sellerTimeout: n,
                ...
                return (0, s.logError)("Could not interpret bidresponse, error details:", e), e
              }
            },
            getUserSyncs: function(e, r, t, i, s) {
              try {
                ...
                if (r && 0 !== r.length) {
                  if (e.iframeEnabled) {
                    const e = r.filter((e => (0, n.A)(e, "body.ext.iid"))).map((e => e.body.ext.iid)),
                      o = [];
                    t && t.gdprApplies && "string" == typeof t.consentString && o.push(["gdpr_consent", t.consentString]), i && o.push(["us_privacy", i]), s && (o.push(["gpp", s.gppString]), o.push(["gpp_sid", s.applicableSections])), e[0] && (o.push(["informer", e[0]]), a.push({
                      type: "iframe",
                      url: "https://ce.lijit.com/beacon?" + o.map((e => e.join("="))).join("&")
                    }))
                  }
                  e.pixelEnabled && r.filter((e => (0, n.A)(e, "body.ext.sync.pixels"))).reduce(((e, r) => e.concat(r.body.ext.sync.pixels)), []).map((e => e.url)).forEach((e => a.push({
                    type: "image",
                    url: e
                  })))
                }
        ...
        function u(e) {
          ...
          if (!isNaN(t)) return t;
          const i = parseFloat((0, s.getBidIdParameter)("bidfloor", e.params));
          return isNaN(i) ? void 0 : i
        }(0, o.a$)(l), (0, i.E)("sovrnBidAdapter")
      }
    },
    e => {
      e.O(0, [99498, 60802, 37769, 12139, 51085], (() => {
        return r = 32605, e(e.s = r);
        var r
      }));
      e.O()
    }
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [94183], {
      63429: (e, r, t) => {
        ...
        function b(e) {
          let r = {};
          return e.gdprConsent && "boolean" == typeof e.gdprConsent.gdprApplies && a.J(r, "ext.gdpr", e.gdprConsent.gdprApplies ? 1 : 0), e.uspConsent && a.J(r, "ext.us_privacy", e.uspConsent), !0 === p.$W.getConfig("coppa") && (r.coppa = 1), e.ortb2?.regs && s.mergeDeep(r, e.ortb2.regs), r
        }
        ...
        function h(e, r) {
          let t = {};
          e.gdprConsent && a.J(t, "ext.consent", e.gdprConsent.consentString), s.isStr(n.A(e, "bids.0.userId.tdid")) && (t.buyeruid = e.bids[0].userId.tdid);
          var i = n.A(e, "bids.0.userIdAsEids");
          return i && i.length && a.J(t, "ext.eids", i), s.mergeDeep(t, r.user), t
        }
        ...
        function I(e) {
          ...
          n.A(e, "mediaTypes.banner") && (a[d.D4] = function(e) {
          ...
          }(e)), i && (a[d.G_] = function(e) {
            {
              ...
              void 0 !== i && (s.isArray(i[0]) ? (v.w = parseInt(i[0][0]), v.h = parseInt(i[0][1])) : s.isNumber(i[0]) && (v.w = parseInt(i[0]), v.h = parseInt(i[1]))), u && (v.playbackmethod = u), d && (v.plcmt = d), l && (v.pos = l), c && s.isInteger(c) && (v.startdelay = c), !g || 0 !== g && 1 !== g || (v.skip = g), b && s.isInteger(b) && (v.skipmin = b), f && s.isInteger(f) && (v.skipafter = f), y && s.isInteger(y) && (v.minbitrate = y), h && s.isInteger(h) && (v.maxbitrate = h);
          ...
          p && (r.bidfloor = parseFloat(p), r.bidfloorcur = "USD");
          const o = n.A(e, "ortb2Imp.secure");
          r.secure = (0, s.isNumber)(o) ? o : 1;
          const {
            video: m,
            ...u
          } = e.ortb2Imp;
          return s.mergeDeep(r, u), r
        }
        const A = {
          code: u,
          gvlid: 21,
          ...
          supportedMediaTypes: [d.D4, d.G_],
          isBidRequestValid: function(e) {
            if (!e || !e.params) return s.logWarn(u + ": Missing bid parameters"), !1;
            if (!e.params.supplySourceId) return s.logWarn(u + ": Missing required parameter params.supplySourceId"), !1;
            if (!/^[\w+]+$/.test(e.params.supplySourceId)) return s.logWarn(u + ": supplySourceId must only contain alphabetic characters"), !1;
            if (!e.params.publisherId) return s.logWarn(u + ": Missing required parameter params.publisherId"), !1;
            if (e.params.publisherId.length > 32) return s.logWarn(u + ": params.publisherId must be 32 characters or less"), !1;
            if (e.params.bidfloor && isNaN(parseFloat(e.params.bidfloor))) return !1;
            const r = n.A(e, "ortb2Imp.ext.gpid");
            if (!e.params.placementId && !r) return s.logWarn(u + ": one of params.placementId or gpid (via the GPT module https://docs.prebid.org/dev-docs/modules/gpt-pre-auction.html) must be passed"), !1;
            const t = n.A(e, "mediaTypes.banner"),
              i = n.A(e, "mediaTypes.video");
            if (!t && !i) return s.logWarn(u + ": one of mediaTypes.banner or mediaTypes.video must be passed"), !1;
            if (i) {
              if (!i.maxduration || !s.isInteger(i.maxduration)) return s.logWarn(u + ": mediaTypes.video.maxduration must be set to the maximum video ad duration in seconds"), !1;
              if (!i.api || 0 === i.api.length) return s.logWarn(u + ": mediaTypes.video.api should be an array of supported api frameworks. See the Open RTB v2.5 spec for valid values"), !1;
              if (!i.mimes || 0 === i.mimes.length) return s.logWarn(u + ": mediaTypes.video.mimes should be an array of supported mime types"), !1;
              if (!i.protocols) return s.logWarn(u + ": mediaTypes.video.protocols should be an array of supported protocols. See the Open RTB v2.5 spec for valid values"), !1
            }
            return !0
          },
          buildRequests: function(e, r) {
            ...
            return t && t.bcat && (a.bcat = t.bcat), t && t.badv && (a.badv = t.badv), t && t.app && (a.app = t.app), (t && t.pmp || i && i.pmp) && a.imp.forEach((e => {
          ...
          interpretResponse: function(e, r) {
            ...
            return t.forEach((e => {
              e.bid.forEach((e => {
                ...
                e.adomain && e.adomain.length > 0 && (n.meta.advertiserDomains = e.adomain), e.ext.mediatype === l ? Object.assign(n, {
                  width: e.w,
                  height: e.h,
                  ...
                  height: r.video.h,
                  mediaType: d.G_
                }), e.nurl ? n.vastUrl = s.replaceAuctionPrice(e.nurl, t) : n.vastXml = s.replaceAuctionPrice(e.adm, t)), a.push(n)
              }))
            })), a
          },
          ...
          I = {
            ...
            decode(e) {
              const r = function(e) {
                ...
                if ("optout" === e.latestToken) return m("Found optout token.  Refresh is unavailable for this token."), {
                  uid2: {
                    optout: !0
                  }
                };
                if (Date.now() < e.latestToken.identity_expires) return {
                  uid2: {
            ...
            getId(e, r) {
              if (!0 === r?.gdpr?.gdprApplies) return void k("UID2 is not intended for use where GDPR applies. The UID2 module will not run.");
              const t = {
      ...
      34836: (e, t, n) => {
        ...
        function f(e) {
          ...
          return Object.entries(e).forEach((e => {
            ...
            const s = t.get(n);
            let i;
            if ("pubProvidedId" === n) i = (0, u.deepClone)(r);
            else if ("function" == typeof s) try {
              i = s(r), Array.isArray(i) || (i = [i]), i.forEach((e => e.uids = e.uids.filter((e => {
                let {
                  id: t
                } = e;
                return (0, u.isStr)(t)
              ...
              (0, u.logError)(`Could not generate EID for "${n}"`, e)
            } else i = r.map((e => function(e, t, n) {
              if (n && e) {
                let t = {};
                t.source = (0, u.isFn)(n.getSource) ? n.getSource(e) : n.source;
                const o = (0, u.isFn)(n.getValue) ? n.getValue(e) : e;
                if ((0, u.isStr)(o)) {
                  const r = {
                    id: o,
                    atype: n.atype
                  };
                  if ((0, u.isFn)(n.getUidExt)) {
                    const t = n.getUidExt(e);
                    t && (r.ext = t)
                  }
                  if (t.uids = [r], (0, u.isFn)(n.getEidExt)) {
        ...
        function B(e, t) {
          ...
          try {
            const o = new Date(Date.now() + 864e5 * n.expires).toUTCString(),
              r = (0, u.isPlainObject)(t) ? JSON.stringify(t) : t;
                ...
                case $:
                  ! function(e, t, n) {
                    const o = e.config.storage,
                      r = H(e);
                    r(null, t, n), r("_cst", be(), n), "number" == typeof o.refreshInSeconds && r("_last", (new Date).toUTCString(), n)
                  }(e, r, o);
                  break;
                case A:
                  ! function(e, t, n) {
                    const o = e.config.storage,
                      r = e.storageMgr;
                    r.setDataInLocalStorage(`${o.name}_exp`, n), r.setDataInLocalStorage(`${o.name}_cst`, be()), r.setDataInLocalStorage(o.name, encodeURIComponent(t)), "number" == typeof o.refreshInSeconds && r.setDataInLocalStorage(`${o.name}_last`, (new Date).toUTCString())
                  }(e, r, o)
              }
            }))
          } catch (e) {
        ...
        function K(e) {
          Ee(e), e.enabledStorageTypes.forEach((t => {
            switch (t) {
              case $:
                ! function(e) {
                  const t = H(e, T),
          ...
          e.forEach((function(e) {
            ...
            try {
              e.callback((function(o) {
                o ? (e.config.storage && B(e, o), e.idObj = e.submodule.decode(o, e.config), n.refresh(), pe(n)) : (0, u.logInfo)(`${j}: ${e.submodule.name} - request id responded with an empty value`), t()
              }), V.bind(null, e))
            } catch (n) {
              (0, u.logError)(`Error in userID module '${e.submodule.name}':`, n), t()
            }
            e.callback = void 0
          }))
        }
              ...
              e.submodules = e.submodules.filter((e => !n.has(e.submodule))).concat(t),
                function() {
                  ...
                  function r(e, t, n) {
                    return function() {
                      for (const {
                        ...
                        of n) {
                        if (!U.isAllowed(D.yl, (0, v.s)(S.fW, s?.config?.name, {
                            init: !1
                          }))) continue;
                        const i = s.idObj?.[e];
                        if (null != i) {
                          ...
                          if (t) {
                            ...
                            return (0, u.logWarn)(`userID modules ${t(n)} provide the same ID ('${e}'); ${s.submodule.name} is the preferred source, but it's configured only for some bidders, unlike ${t(n.filter((e=>null==e.bidders)))}. Other bidders will not see the "${e}" ID.`), null
                          }
                  ...
                  Object.entries(t).forEach((e => {
                    ...
                    s = s.map((e => {
                      let t = null;
                      return Array.isArray(e.config.bidders) && e.config.bidders.length > 0 ? (t = e.config.bidders, t.forEach((e => a.add(e)))) : i = !1, {
                        module: e,
                        bidders: t
                      }
                    })), i || (n[t] = r(t, !0, s.map((e => {
        ...
        function Z(e) {
          ...
          if (n = n ?? {
              ...
              s.length > 0 && (0, b.J)(t, "user.ext.eids", (t.user?.ext?.eids ?? []).concat(s)), Object.entries(r).forEach((e => {
                let [t, o] = e;
                const r = g(o);
                r.length > 0 && (0, b.J)(n, `${t}.user.ext.eids`, (n[t]?.user?.ext?.eids ?? []).concat(r))
              }))
            }(n), [t].some((e => !Array.isArray(e) || !e.length))) return;
          const o = z(x.global),
            r = n.global.user?.ext?.eids || [];
          t.forEach((e => {
            e.bids && (0, u.isArray)(e.bids) && e.bids.forEach((e => {
        ...
        function ne() {
          ...
          if (t && "string" == typeof t?.uids?.[0]?.id) {
            ...
            (0, u.logWarn)(`User ID - Googletag Publisher Provided ID for ${_} is not between 32 and 150 characters - ${e}`)
          }
        }
        const oe = (0, y.Ak)("userId", (function(e, t) {
            let {
              mkDelay: n = p.cb,
              getIds: o = me
            } = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            p.U9.race([o().catch((() => null)), n(L)]).then((() => {
              Z(t), J().join((0, y.BO)(t.metrics), {
                propagate: !1,
                includeGroups: !0
              }), e.call(this, t)
            }))
          })),
          re = (0, y.Ak)("userId", (function(e, t) {
            Z(t), e.call(this, t)
          }));
        ...
        function ce(e, t, n) {
          return fe().then((() => {
            let o = {};
            if ((0, u.isFn)(n)) {
              (0, u.logInfo)(`${j} - Getting encrypted signal from custom function : ${n.name} & source : ${e} `);
              const t = n(e);
              o[e] = t ? ue(t) : null
            } else {
              const n = le(e);
              (0, u.logInfo)(`${j} - Getting encrypted signal for eids :${JSON.stringify(n)}`), (0, u.isEmpty)(n) || (o[n.source] = !0 === t ? ue(n) : n.uids[0].id)
            }
            return (0, u.logInfo)(`${j} - Fetching encrypted eids: ${o[e]}`), o[e]
          }))
        }
        ...
        function de() {
          if (!(0, u.isGptPubadsDefined)()) return;
          ...
          } else(0, u.logWarn)(`${j} - ESP : encryptedSignalSources config not defined under userSync Object`)
        }

        function fe(e) {
          return te(e).then((() => ie()), (e => e === ee ? Promise.resolve().then(me) : ((0, u.logError)("Error initializing userId", e), p.U9.reject(e))))
        }

        function ge() {
          let {
            submoduleNames: e
          } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, t = arguments.length > 1 ? arguments[1] : void 0;
          return fe({
            refresh: !0,
            submoduleNames: e
          }).then((e => (t && (0, u.isFn)(t) && t(), e)))
        }
        ...
        function he(e, t) {
          ...
          if (e.config.storage) {
            ...
            (0, u.isPlainObject)(o) && (o.id && (B(e, o.id), r = o.id), "function" == typeof o.callback && (e.callback = o.callback)), r && (e.idObj = e.submodule.decode(r, e.config))
          } else if (e.config.value) e.idObj = e.config.value;
          else {
            const t = e.submodule.getId(e.config, n);
            (0, u.isPlainObject)(t) && ("function" == typeof t.callback && (e.callback = t.callback), t.id && (e.idObj = e.submodule.decode(t.id, e.config)))
          }
        }
        ...
        function pe(e) {
          ...
          if (t.length && _) {
            const e = ne(t);
            e && ((0, u.isGptPubadsDefined)() ? window.googletag.pubads().setPublisherProvidedId(e) : (window.googletag = window.googletag || {}, window.googletag.cmd = window.googletag.cmd || [], window.googletag.cmd.push((function() {
        ...
        function ye(e, t) {
          ...
          return J().fork().measureTime("userId.init.modules", (function() {
            if (!t.length) return [];
            if (t.forEach((e => Ee(e))), !(t = t.filter((e => (!e.config.storage || !!e.enabledStorageTypes.length) && U.isAllowed(D.yl, (0, v.s)(S.fW, e.config.name))))).length) return (0, u.logWarn)(`${j} - no ID module configured`), [];
            const o = t.reduce(((e, t) => R(t.submodule.name).measureTime("init", (() => {
              try {
                he(t, n), e.push(t)
              } catch (e) {
                (0, u.logError)(`Error in userID module '${t.submodule.name}':`, e)
              }
              return e
            }))), []);
            return e.refresh(o), pe(e), o
          }))
        }
        ...
        function we(e) {
          function t(e) {
            ...
            (0, u.logWarn)(`Invalid userSync.userId config: ${e}`, ...n)
          }
          return Array.isArray(e) ? e.filter((e => {
            ...
            if (e.storage) {
              ...
              if (! function(e) {
                ...
                }(e)) return t('invalid "storage.type"', e);
              ["expires", "refreshInSeconds"].forEach((n => {
                let o = e.storage[n];
                null != o && "number" != typeof o && (o = Number(o), isNaN(o) ? (t(`storage.${n} must be a number and will be ignored`, e), delete e.storage[n]) : e.storage[n] = o)
              }))
            }
            return !0
        ...
        function Ee(e) {
          ...
          e.enabledStorageTypes = t.filter((t => {
            switch (t) {
              case A:
                return function(e) {
                  return !(!e.storageMgr.localStorageIsEnabled() || T.getDataFromLocalStorage(C) && ((0, u.logInfo)(`${j} - opt-out localStorage found, storage disabled`), 1))
                }(e);
              case $:
                return function(e) {
                  return !(!e.storageMgr.cookiesAreEnabled() || T.getCookie(C) && ((0, u.logInfo)(`${j} - opt-out cookie found, storage disabled`), 1))
                }(e)
            }
            return !1
          }))
        ...
        function De(e) {
          d.clear(), Object.entries(Q(e, (e => Object.keys(e.eids || {})), (e => e))).forEach((e => {
            let [t, n] = e;
        ...
        function ve() {
          ...
          const e = we(q);
          if (!e.length) return;
          const t = G.filter((e => !(0, r.I6)(W, (t => t.name === e.name))));
          W.splice(0, W.length), t.map((t => {
            const n = (0, r.I6)(e, (e => e.name && (e.name.toLowerCase() === t.name.toLowerCase() || t.aliasName && e.name.toLowerCase() === t.aliasName.toLowerCase())));
            return n && t.name !== n.name && (n.name = t.name), n ? {
              submodule: t,
              config: n,
              callback: void 0,
              idObj: void 0,
          ...
          })).filter((e => null !== e)).forEach((e => W.push(e))), W.length && (se() || (k.gH.getHooks({
            hook: re
          }).remove(), k.gH.before(oe, 100), a.Ay.callDataDeletionRequest.before(Oe), h.Q.after((e => e(ne())))), (0, u.logInfo)(`${j} - usersync config updated for ${W.length} submodules: `, W.map((e => e.submodule.name))))
        }

        function Oe(e) {
          for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), o = 1; o < t; o++) n[o - 1] = arguments[o];
          (0, u.logInfo)("UserID: received data deletion request; deleting all stored IDs..."), W.forEach((e => {
            if ("function" == typeof e.submodule.onDataDeletionRequest) try {
              e.submodule.onDataDeletionRequest(e.config, e.idObj, ...n)
            } catch (t) {
              (0, u.logError)(`Error calling onDataDeletionRequest for ID submodule ${e.submodule.name}`, t)
            }
            K(e)
          })), e.apply(this, n)
        }
        ...
        function je(e) {
          ...
          _ = void 0, W = [], q = [], x = X(), te = function() {
            ...
            function a(e) {
              return r = J().fork(), null != o && o.reject(ee), o = (0, p.v6)(), p.U9.race([e, o.promise]).finally(r.startTiming("userId.total"))
            }
            let d = x,
              f = W;
            ...
            let b = a(p.U9.all([c.Gc, t.promise]).then(m).then(g((() => {
              ...
              const e = d.submodules.filter((e => (0, u.isFn)(e.callback)));
              if (e.length) return new p.U9((t => Y(e, t, d)))
            }))));
            return function() {
              let {
                refresh: o = !1,
              ...
              return c && !s && (s = !0, t.resolve(), L > 0 ? n.resolve() : i.on(l.qY.AUCTION_END, (function t() {
                i.off(l.qY.AUCTION_END, t), e(P).then(n.resolve)
            ...
            mkDelay: t
          }), null != F && F(), G = [], F = e.getConfig("userSync", (e => {
            const t = e.userSync;
            t && (_ = t.ppid, t.userIds && (q = t.userIds, P = (0, u.isNumber)(t.syncDelay) ? t.syncDelay : O.qh.syncDelay, L = (0, u.isNumber)(t.auctionDelay) ? t.auctionDelay : O.qh.auctionDelay, ve(), function(e, t) {
              if (e) {
                const n = {},
                  o = new Map(t.map((e => e.aliasName ? [e.aliasName, e.name] : [])));
                Object.keys(e).forEach((t => {
                  const r = (0, u.isArray)(e[t]) ? [...e[t]].reverse() : [];
          ...
          })), (0, o.m)().getUserIds = ie, (0, o.m)().getUserIdsAsEids = ae, (0, o.m)().getEncryptedEidsForSource = ke(ce), (0, o.m)().registerSignalSources = de, (0, o.m)().refreshUserIds = ke(ge), (0, o.m)().getUserIdsAsync = ke(me), (0, o.m)().getUserIdsAsEidBySource = le, se() || k.gH.before(re, 100)
        }
        je(s.$W), (0, c.xG)("userId", (function(e) {
          e.findRootDomain = I.S, (0, r.I6)(G, (t => t.name === e.name)) || (G.push(e), w.o2.register(S.fW, e.name, e.gvlid), ve(), te({
            refresh: !0,
  ...
  (self.pbjsChunk = self.pbjsChunk || []).push([
    [47957], {
      93043: (e, s, o) => {
        ...
        (0, n.a$)(g), (0, i.E)("vidazooBidAdapter")
      }
    },
    e => {
      e.O(0, [44982, 85946, 60802, 37769, 12139, 51085], (() => {
        return s = 93043, e(e.s = s);
        var s
      }));
      e.O()
    }
